  ...
  'Security': {
    ...
    subcategories: {
      ...
      'Supply Chain & TLS': [
        ...
        { path: '/api/security/dns-exfil-risk', name: 'DNS Exfil Risk', icon: '\u1F50C' },
        { path: '/api/security/port-forward-audit', name: 'Port Forward', icon: '\u2192' },
        { path: '/api/security/image-provenance', name: 'Image Provenance', icon: '\u1F4E6' },
      ],
    },
  },
  'Operations': {
