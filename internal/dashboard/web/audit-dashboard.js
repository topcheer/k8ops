  ...
  'Product': {
    ...
    subcategories: {
      ...
      'Network & Exposure': [
        ...
        { path: '/api/product/dns-config-v2566', name: 'DNSConfig', icon: '\u{1F310}' },
        { path: '/api/product/limit-vs-req-ratio-v2566', name: 'Limit vs Req Ratio', icon: '\u{1F4CA}' },
        { path: '/api/product/external-name-v2566', name: 'ExternalName Svc', icon: '\u{1F517}' },
        { path: '/api/deploy/rs-annotations-v2567', name: 'RS Annotations', icon: '\u{1F3F7}' },
        { path: '/api/deploy/sts-service-name-v2567', name: 'STS ServiceName', icon: '\u{1F697}' },
        { path: '/api/deploy/ds-node-selector-v2567', name: 'DS NodeSelector', icon: '\u{1F50D}' },
        { path: '/api/ops/node-cond-summary-v2568', name: 'Node Cond Summary', icon: '\u2705' },
        { path: '/api/ops/pod-tolerations-count-v2568', name: 'Pod Tolerations', icon: '\u{1F6E1}' },
        { path: '/api/ops/ephemeral-req-v2568', name: 'Ephemeral Req', icon: '\u{1F4BF}' },
        { path: '/api/security/priv-esc-v2569', name: 'PrivEsc', icon: '\u26A0' },
        { path: '/api/security/secret-label-count-v2569', name: 'Secret LabelCount', icon: '\u{1F3F7}' },
        { path: '/api/security/rb-subject-kind-v2569', name: 'RB SubjectKind', icon: '\u{1F465}' },
        { path: '/api/docs/node-kubeproxy-dist-v2570', name: 'Node KubeProxy Dist', icon: '\u{1F4BB}' },
        { path: '/api/docs/pod-node-affinity-v2570', name: 'Pod NodeAffinity', icon: '\u{1F517}' },
        { path: '/api/docs/ns-annot-vs-fin-v2570', name: 'NS Annot vs Fin', icon: '\u{1F3F7}' },
        { path: '/api/scalability/top-ns-by-secret2-v2571', name: 'Top NS by Secret v2', icon: '\u{1F511}' },
        { path: '/api/scalability/node-cpu-req-vs-alloc-v2571', name: 'Node CPUReq vs Alloc', icon: '\u26A1' },
        { path: '/api/scalability/cronjob-schedule-v2571', name: 'CronJob Schedule', icon: '\u{1F552}' },
        { path: '/api/product/pod-gmsa-v2572', name: 'Pod GMSA', icon: '\u{1F510}' },
        { path: '/api/product/mem-req-vs-lim-v2572', name: 'MemReq vs Lim', icon: '\u{1F4CA}' },
        { path: '/api/product/lb-class-v2572', name: 'LB Class', icon: '\u{1F697}' },
        { path: '/api/deploy/rs-min-ready-v2573', name: 'RS MinReady', icon: '\u23F1' },
        { path: '/api/deploy/sts-pod-mgmt-v2573', name: 'STS PodMgmt', icon: '\u{1F504}' },
        { path: '/api/deploy/ds-host-net-v2573', name: 'DS HostNet', icon: '\u{1F310}' },
        { path: '/api/ops/node-cpu-alloc-vs-req-v2574', name: 'Node CPUAlloc vs Req', icon: '\u26A1' },
        { path: '/api/ops/priority-class-dist-v2574', name: 'PriorityClass Dist', icon: '\u26A1' },
        { path: '/api/ops/term-signal-v2574', name: 'Term Signal', icon: '\u{1F4DD}' },
        { path: '/api/security/fsgroup-detail-v2575', name: 'FSGroup Detail', icon: '\u{1F510}' },
        { path: '/api/security/secret-revision-v2575', name: 'Secret Revision', icon: '\u{1F522}' },
        { path: '/api/security/crb-subject-ns-v2575', name: 'CRB SubjectNS', icon: '\u{1F4CD}' },
        { path: '/api/docs/node-os-image-dist-v2576', name: 'Node OSImage Dist', icon: '\u{1F4BB}' },
        { path: '/api/docs/host-aliases-summary-v2576', name: 'HostAliases Summary', icon: '\u{1F4CD}' },
        { path: '/api/docs/ns-label-count-v2576', name: 'NS LabelCount', icon: '\u{1F3F7}' },
        { path: '/api/scalability/top-ns-by-deploy2-v2577', name: 'Top NS by Deploy v2', icon: '\u{1F4C8}' },
        { path: '/api/scalability/node-mem-req-total-v2577', name: 'Node MemReq Total', icon: '\u{1F4A7}' },
        { path: '/api/scalability/service-total-by-type-v2577', name: 'Svc Total by Type', icon: '\u{1F697}' },
        { path: '/api/product/topology-count-v2578', name: 'Topology Count', icon: '\u{1F310}' },
        { path: '/api/product/stdin-config-v2578', name: 'Stdin Config', icon: '\u2328' },
        { path: '/api/product/svc-clusterip-detail-v2578', name: 'Svc ClusterIP Detail', icon: '\u{1F310}' },
        { path: '/api/deploy/rs-template-hash-v2579', name: 'RS TemplateHash', icon: '\u{1F522}' },
        { path: '/api/deploy/sts-cur-vs-rep-v2579', name: 'STS Cur vs Rep', icon: '\u{1F4CF}' },
        { path: '/api/deploy/ds-update-strategy-v2579', name: 'DS UpdateStrategy', icon: '\u{1F504}' },
        { path: '/api/ops/node-alloc-cap-ratio-v2580', name: 'Node AllocCap Ratio', icon: '\u{1F4CA}' },
        { path: '/api/ops/image-pull-secrets-detail-v2580', name: 'ImagePullSecrets Detail', icon: '\u{1F50C}' },
        { path: '/api/ops/env-from-count-v2580', name: 'EnvFrom Count', icon: '\u{1F4CB}' },
        { path: '/api/security/seccomp-detail-v2581', name: 'Seccomp Detail', icon: '\u{1F6E1}' },
        { path: '/api/security/secret-data-key-v2581', name: 'Secret DataKey', icon: '\u{1F511}' },
        { path: '/api/security/crb-subject-name-v2581', name: 'CRB SubjectName', icon: '\u{1F465}' },
        { path: '/api/docs/node-stor-vs-cap-v2582', name: 'Node Stor vs Cap', icon: '\u{1F4BF}' },
        { path: '/api/docs/ctnr-port-summary-v2582', name: 'Ctnr Port Summary', icon: '\u{1F4F1}' },
        { path: '/api/docs/ns-age-dist-v2582', name: 'NS Age Dist', icon: '\u{1F4C5}' },
        { path: '/api/scalability/top-ns-by-ds2-v2583', name: 'Top NS by DS v2', icon: '\u{1F4C8}' },
        { path: '/api/scalability/node-cpu-lim-vs-alloc-v2583', name: 'Node CPULim vs Alloc', icon: '\u26A1' },
        { path: '/api/scalability/epslice-total-2583', name: 'EPSlice Total', icon: '\u{1F4CD}' },
