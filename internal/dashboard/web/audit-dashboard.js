  ...
  'Security': {
    ...
    subcategories: {
      ...
      'Compliance & Policy': [
        ...
        { path: '/api/security/linux-capabilities-audit', name: 'Linux Caps', icon: '\u1F512' },
        { path: '/api/security/egress-traffic-audit', name: 'Egress Audit', icon: '\u1F517' },
        { path: '/api/security/node-hardening-score', name: 'Node Hardening', icon: '\u1F6E1' },
        { path: '/api/security/run-as-non-root-audit', name: 'Non-Root Audit', icon: '\u1F6AB' },
        { path: '/api/security/host-pid-ipc-audit', name: 'Host PID/IPC', icon: '\u1F510' },
        { path: '/api/security/image-digest-pinning', name: 'Digest Pinning', icon: '\u1F527' },
        { path: '/api/security/container-uid-gid', name: 'UID/GID', icon: '\u1F464' },
        { path: '/api/security/default-sa-binding', name: 'Default SA', icon: '\u1F511' },
        { path: '/api/security/pod-security-posture-v2', name: 'Posture V2', icon: '\u1F6E1' },
        { path: '/api/security/sa-privilege-scope', name: 'SA Priv Scope', icon: '\u1F511' },
        { path: '/api/security/token-audit-trail', name: 'Token Audit', icon: '\u1F4CB' },
        { path: '/api/security/secret-volume-exposure', name: 'Secret Vol Exp', icon: '\u1F512' },
        { path: '/api/security/rbac-wildcard-verb', name: 'RBAC Wildcard', icon: '\u26A0' },
        { path: '/api/security/anonymous-auth-risk', name: 'Anon Auth', icon: '\u1F6E1' },
        { path: '/api/security/node-restriction-label', name: 'Node Restrict', icon: '\u1F6AB' },
        { path: '/api/security/priv-esc-audit', name: 'Priv Esc', icon: '\u2B06' },
        { path: '/api/security/seccomp-profile-audit', name: 'Seccomp', icon: '\u1F6E1' },
        { path: '/api/security/cap-drop-audit', name: 'Cap Drop', icon: '\u2696' },
        { path: '/api/security/host-path-audit', name: 'HostPath', icon: '\u1F4C2' },
        { path: '/api/security/readonly-rootfs', name: 'RO RootFS', icon: '\u1F512' },
        { path: '/api/security/sa-token-age', name: 'SA Token Age', icon: '\u23F1' },
        { path: '/api/security/fs-group-audit', name: 'FSGroup', icon: '\u1F465' },
        { path: '/api/security/proc-mount-type', name: 'Proc Mount', icon: '\u1F4E6' },
        { path: '/api/security/kernel-param-access', name: 'Kernel Param', icon: '\u2699' },
        { path: '/api/security/sa-image-pull-secret', name: 'SA Pull Sec', icon: '\u1F511' },
        { path: '/api/security/pod-dns-policy-restrict', name: 'DNS Policy', icon: '\u1F310' },
        { path: '/api/security/container-run-as-user', name: 'RunAsUser', icon: '\u1F464' },
        { path: '/api/security/validating-webhook-coverage', name: 'Val Webhook', icon: '\u2705' },
        { path: '/api/security/ingress-tls-cert-age', name: 'TLS Cert', icon: '\u1F510' },
        { path: '/api/security/sa-token-volume', name: 'SA Token Vol', icon: '\u1F4DC' },
        { path: '/api/security/container-cap-effective', name: 'Cap Effective', icon: '\u2696' },
        { path: '/api/security/secret-type-coverage', name: 'Secret Type', icon: '\u1F511' },
        { path: '/api/security/pod-serviceaccount-mapping', name: 'SA Mapping', icon: '\u1F517' },
      ...
      'Supply Chain & TLS': [
        ...
        { path: '/api/security/secret-exposure-graph', name: 'Secret Graph', icon: '\u1F510' },
        { path: '/api/security/admission-exception', name: 'Admission Exc', icon: '\u1F6E1' },
        { path: '/api/security/proc-mount-risk', name: 'Proc Mount', icon: '\u1F527' },
        { path: '/api/security/volume-mount-audit', name: 'Volume Mount', icon: '\u1F4C1' },
        { path: '/api/security/priv-esc-risk', name: 'Priv Esc Risk', icon: '\u1F6A8' },
        { path: '/api/security/image-base-scan', name: 'Base Image', icon: '\u1F4F7' },
        { path: '/api/docs/label-standardization', name: 'Label Std', icon: '\u1F3F7' },
        { path: '/api/docs/resource-age-distribution', name: 'Age Dist', icon: '\u1F4C5' },
        { path: '/api/docs/ns-isolation-matrix', name: 'NS Isolation', icon: '\u1F310' },
        { path: '/api/product/mesh-ready-check', name: 'Mesh Check', icon: '\u1F575' },
        { path: '/api/product/vol-access-audit', name: 'Vol Access', icon: '\u1F4BE' },
        { path: '/api/product/pdb-gap-analysis-v2', name: 'PDB Gap v2', icon: '\u1F6E1' },
        { path: '/api/security/token-projection', name: 'Token Projection', icon: '\u1F510' },
        { path: '/api/security/sysctl-risk', name: 'Sysctl Risk', icon: '\u2699' },
        { path: '/api/security/hostport-exposure', name: 'HostPort Map', icon: '\u1F6A7' },
      ],
    },
  },
  'Operations': {
    ...
    subcategories: {
      ...
      'Phase & Lifecycle': [
        ...
        { path: '/api/operations/storage-io-latency', name: 'Storage Latency', icon: '\u1F4BE' },
        { path: '/api/operations/network-packet-loss', name: 'Network Loss', icon: '\u1F310' },
        { path: '/api/operations/cgroup-pressure', name: 'Cgroup Pressure', icon: '\u1F4C9' },
        { path: '/api/operations/ingress-health', name: 'Ingress Health', icon: '\u1F310' },
        { path: '/api/operations/job-lifecycle', name: 'Job Lifecycle', icon: '\u1F4CB' },
        { path: '/api/operations/leader-election', name: 'Leader Election', icon: '\u1F451' },
        { path: '/api/operations/pvc-lifecycle', name: 'PVC Lifecycle', icon: '\u1F4BE' },
        { path: '/api/operations/endpoint-latency', name: 'Endpoint Latency', icon: '\u23F1' },
        { path: '/api/operations/container-forensics', name: 'Container Forensics', icon: '\u1F50D' },
      ],
    },
  },
  'Scalability': {
    ...
    subcategories: {
      ...
      'Quota & Multi-Tenant': [
        ...
        { path: '/api/scalability/pod-spread-violation', name: 'Pod Spread', icon: '\u1F4CD' },
        { path: '/api/scalability/ha-topo-score', name: 'HA Topology', icon: '\u1F30D' },
        { path: '/api/deployment/revision-timeline', name: 'Rev Timeline', icon: '\u1F4DC' },
        { path: '/api/deployment/qos-distribution', name: 'QoS Dist', icon: '\u2696' },
        { path: '/api/deployment/ds-health', name: 'DS Health', icon: '\u1F4E6' },
        { path: '/api/operations/hpa-scaling-events', name: 'HPA Scale Events', icon: '\u2195' },
        { path: '/api/operations/node-cond-history', name: 'Node Cond Hist', icon: '\u1F4C9' },
        { path: '/api/operations/config-change-tracker', name: 'Config Changes', icon: '\u1F4DD' },
        { path: '/api/security/rbac-overexpose', name: 'RBAC Overexpose', icon: '\u1F511' },
        { path: '/api/security/secret-enc-rest', name: 'Secret Enc', icon: '\u1F512' },
        { path: '/api/security/webhook-risk', name: 'Webhook Risk', icon: '\u26D4' },
        { path: '/api/docs/ownership-registry-v2', name: 'Ownership v2', icon: '\u1F465' },
        { path: '/api/docs/api-resource-inventory', name: 'API Inventory', icon: '\u1F4E6' },
        { path: '/api/docs/capacity-report', name: 'Capacity Report', icon: '\u1F4CF' },
      ...
      'Pressure & Capacity Forecast': [
        ...
        { path: '/api/scalability/dns-scalability', name: 'DNS Scale', icon: '\u1F310' },
        { path: '/api/scalability/conn-pool-exhaustion', name: 'Conn Pool Risk', icon: '\u1F517' },
      ],
    },
  },
  'Product': {
    ...
    subcategories: {
      ...
      'Network & Exposure': [
        ...
        { path: '/api/product/image-lifecycle', name: 'Image Lifecycle', icon: '\u1F4E6' },
        { path: '/api/product/volume-snapshot-readiness', name: 'Snapshot Ready', icon: '\u1F4F7' },
        { path: '/api/product/idle-resource', name: 'Idle Resource', icon: '\u1F634' },
        { path: '/api/product/secret-version-history', name: 'Secret Version', icon: '\u1F510' },
        { path: '/api/product/crd-health', name: 'CRD Health', icon: '\u1F9E9' },
        { path: '/api/product/autosize-recommender', name: 'Autosize Rec', icon: '\u1F4CF' },
        { path: '/api/product/res-wastage', name: 'Res Wastage', icon: '\u1F4B8' },
        { path: '/api/product/sa-usage-tracker', name: 'SA Usage', icon: '\u1F464' },
        { path: '/api/product/ep-slice-health', name: 'EP Slice', icon: '\u1F4CA' },
        { path: '/api/scalability/res-pressure-score', name: 'Res Pressure', icon: '\u1F525' },
        { path: '/api/scalability/anti-affinity-coverage', name: 'Anti-Affinity', icon: '\u1F6E1' },
        { path: '/api/scalability/startup-latency', name: 'Startup Latency', icon: '\u23F1' },
        { path: '/api/deployment/pause-detect', name: 'Pause Detect', icon: '\u23F8' },
        { path: '/api/deployment/tag-compliance', name: 'Tag Comply', icon: '\u1F3F7' },
        { path: '/api/deployment/rollout-strategy', name: 'Rollout Strat', icon: '\u1F504' },
        { path: '/api/operations/restart-storm', name: 'Restart Storm', icon: '\u26A1' },
        { path: '/api/operations/event-storm', name: 'Event Storm', icon: '\u1F4A5' },
        { path: '/api/operations/taint-impact', name: 'Taint Impact', icon: '\u1F6AB' },
        { path: '/api/security/netpol-coverage-v2', name: 'NetPol Coverage', icon: '\u1F310' },
        { path: '/api/security/seccomp-exposure', name: 'Seccomp', icon: '\u1F6E1' },
        { path: '/api/security/api-discovery-exposure', name: 'API Discovery', icon: '\u1F441' },
        { path: '/api/docs/dependency-graph', name: 'Dep Graph', icon: '\u1F578' },
        { path: '/api/docs/storage-class-inventory', name: 'SC Inventory', icon: '\u1F4BE' },
        { path: '/api/docs/dns-resolution-map', name: 'DNS Map', icon: '\u1F310' },
        { path: '/api/product/vol-snapshot-audit', name: 'Vol Snapshot', icon: '\u1F4F7' },
        ...
        { path: '/api/scalability/gc-pressure', name: 'GC Pressure', icon: '\u1F5D1' },
        { path: '/api/scalability/pod-limit-proximity', name: 'Pod Limit', icon: '\u1F4CF' },
        { path: '/api/deployment/sts-ordinal-health', name: 'STS Ordinal', icon: '\u1F522' },
        ...
        { path: '/api/docs/cluster-config-snap', name: 'Config Snap', icon: '\u1F4CB' },
        { path: '/api/docs/event-history-doc', name: 'Event History', icon: '\u1F4C4' },
        { path: '/api/docs/quota-doc', name: 'Quota Doc', icon: '\u1F4D1' },
        ...
        { path: '/api/product/ns-lifecycle-tracker', name: 'NS Lifecycle', icon: '\u1F310' },
        { path: '/api/scalability/node-frag-analysis', name: 'Node Frag', icon: '\u1F4A2' },
        { path: '/api/scalability/ctrl-queue-pressure', name: 'Ctrl Queue', icon: '\u1F4C4' },
        { path: '/api/scalability/pod-density-optimizer', name: 'Pod Density Opt', icon: '\u1F4CA' },
        { path: '/api/deployment/canary-detector', name: 'Canary Detect', icon: '\u1F426' },
        { path: '/api/deployment/init-container-overhead', name: 'Init Overhead', icon: '\u23F3' },
        { path: '/api/deployment/lifecycle-hook-comp', name: 'Lifecycle Hooks', icon: '\u1F504' },
        { path: '/api/operations/oom-forecast', name: 'OOM Forecast', icon: '\u26A0' },
        { path: '/api/operations/api-request-pattern', name: 'API Pattern', icon: '\u1F4CA' },
        { path: '/api/operations/terminated-reason-catalog', name: 'Term Catalog', icon: '\u1F4CB' },
        { path: '/api/operations/quota-waste-detector', name: 'Quota Waste', icon: '\u1F4B8' },
        { path: '/api/operations/admission-health', name: 'Admission Health', icon: '\u1F510' },
        { path: '/api/operations/clock-sync', name: 'Clock Sync', icon: '\u23F1' },
        { path: '/api/operations/pod-restart-cost', name: 'Restart Cost', icon: '\u1F4B0' },
        { path: '/api/operations/node-disk-io-health', name: 'Disk I/O', icon: '\u1F4BE' },
        { path: '/api/operations/event-qps-analyzer', name: 'Event QPS', icon: '\u1F4CA' },
        { path: '/api/operations/pod-age-distribution', name: 'Pod Age', icon: '\u1F4C5' },
        { path: '/api/operations/node-condition-flap', name: 'Node Flap', icon: '\u1F4C9' },
        ...
        { path: '/api/operations/ns-resource-pressure', name: 'NS Pressure', icon: '\u1F525' },
        { path: '/api/operations/pod-probe-latency', name: 'Probe Config', icon: '\u1F50D' },
        { path: '/api/operations/image-pull-duration', name: 'Image Pull', icon: '\u23F3' },
        { path: '/api/operations/config-reload-health', name: 'Config Reload', icon: '\u1F504' },
        ...
        { path: '/api/operations/node-pressure-budget', name: 'Node Budget', icon: '\u1F4CF' },
        { path: '/api/operations/event-budget', name: 'Event Budget', icon: '\u1F4CB' },
        { path: '/api/operations/net-policy-budget', name: 'NetPol Budget', icon: '\u1F6E1' },
        { path: '/api/operations/pod-init-time', name: 'Pod Init', icon: '\u23F1' },
        { path: '/api/operations/kubelet-cert-expiry', name: 'Kubelet Cert', icon: '\u1F511' },
        { path: '/api/operations/ns-event-noise', name: 'Event Noise', icon: '\u1F4E2' },
        { path: '/api/operations/pod-taint-toleration-match', name: 'Taint Match', icon: '\u1F6DE' },
        { path: '/api/operations/node-condition-budget', name: 'Node Cond', icon: '\u2705' },
        { path: '/api/operations/cluster-log-volume', name: 'Log Volume', icon: '\u1F4DD' },
        { path: '/api/operations/pod-crash-loop-detect', name: 'Crash Loop', icon: '\u1F534' },
        { path: '/api/operations/deployment-replica-health', name: 'Replica Health', icon: '\u1F4C9' },
        { path: '/api/operations/event-warning-hotspot', name: 'Evt Hotspot', icon: '\u1F525' },
        { path: '/api/operations/pod-phase-distribution', name: 'Pod Phase', icon: '\u1F4CA' },
        { path: '/api/operations/container-restart-reason', name: 'Restart Reason', icon: '\u1F501' },
        { path: '/api/operations/node-kubelet-version', name: 'Kubelet Ver', icon: '\u1F527' },
        { path: '/api/operations/pod-cpu-throttling-estimator', name: 'CPU Throt Est', icon: '\u1F525' },
        { path: '/api/operations/namespace-resource-pressure', name: 'NS Pressure', icon: '\u1F4CF' },
        { path: '/api/operations/event-age-decay-tracker', name: 'Evt Age Decay', icon: '\u1F4CB' },
        { path: '/api/security/psa-violation', name: 'PSA Violation', icon: '\u1F6E1' },
        { path: '/api/security/automount-risk', name: 'AutoMount Risk', icon: '\u1F511' },
        { path: '/api/security/registry-trust', name: 'Registry Trust', icon: '\u1F4DC' },
        { path: '/api/security/secret-mount-exposure', name: 'Secret Exposure', icon: '\u1F510' },
        { path: '/api/security/bare-namespace-netpol', name: 'Bare NS NetPol', icon: '\u1F6E1' },
        ...
        { path: '/api/docs/pdb-coverage', name: 'PDB Coverage', icon: '\u1F6E1' },
        { path: '/api/docs/sa-token-age', name: 'SA Token Age', icon: '\u1F511' },
        { path: '/api/product/cost-anomaly-detector', name: 'Cost Anomaly', icon: '\u1F4B0' },
        { path: '/api/product/right-size-recommender', name: 'Right-Size', icon: '\u1F4CF' },
        { path: '/api/product/image-dedup-report', name: 'Image Dedup', icon: '\u1F4BE' },
        { path: '/api/scalability/hpa-headroom', name: 'HPA Headroom', icon: '\u1F4C8' },
        { path: '/api/scalability/az-spread-validator', name: 'AZ Spread', icon: '\u1F310' },
        { path: '/api/scalability/leader-election-audit', name: 'Leader Election', icon: '\u1F451' },
        { path: '/api/deployment/revision-tracker', name: 'Rev Tracker', icon: '\u1F501' },
        { path: '/api/deployment/lifecycle-hook-audit', name: 'Lifecycle Hooks', icon: '\u23F1' },
        { path: '/api/deployment/topo-constraint-validator', name: 'Topo Constraint', icon: '\u1F5FA' },
        { path: '/api/operations/restart-budget', name: 'Restart Budget', icon: '\u1F501' },
        { path: '/api/operations/volume-iops-estimate', name: 'Vol IOPS Est', icon: '\u1F4BF' },
        { path: '/api/operations/node-allocatable-budget', name: 'Node Alloc Budget', icon: '\u1F4B0' },
        { path: '/api/security/image-tag-immutability', name: 'Tag Immutability', icon: '\u1F4E6' },
        { path: '/api/security/rbac-wildcard-audit', name: 'RBAC Wildcard', icon: '\u1F510' },
        { path: '/api/security/security-context-baseline', name: 'SecCtx Baseline', icon: '\u1F6E1' },
        { path: '/api/docs/label-taxonomy', name: 'Label Taxonomy', icon: '\u1F3F7' },
        { path: '/api/docs/annotation-inventory-doc', name: 'Annot Inventory', icon: '\u1F4DD' },
        { path: '/api/docs/quota-cross-ref', name: 'Quota XRef', icon: '\u1F4D1' },
        { path: '/api/product/workload-age-profile', name: 'Wkld Age', icon: '\u1F4C5' },
        { path: '/api/product/service-mesh-readiness', name: 'Mesh Ready', icon: '\u1F310' },
        { path: '/api/product/tls-expiry-forecast', name: 'TLS Forecast', icon: '\u1F510' },
        { path: '/api/scalability/node-capacity-headroom', name: 'Node Headroom', icon: '\u1F4CF' },
        { path: '/api/scalability/pod-density-analyzer', name: 'Pod Density', icon: '\u1F4CA' },
        { path: '/api/scalability/storage-capacity-forecast', name: 'Storage Forecast', icon: '\u1F4BF' },
        ...
        { path: '/api/product/cross-ns-traffic-estimator', name: 'X-NS Traffic', icon: '\u1F517' },
        { path: '/api/deployment/rollout-window', name: 'Rollout Window', icon: '\u23F1' },
        { path: '/api/deployment/init-container-map', name: 'Init Container', icon: '\u1F527' },
        { path: '/api/deployment/probe-config-validator', name: 'Probe Config', icon: '\u1F50D' },
        { path: '/api/operations/dns-health-2039', name: 'DNS Health', icon: '\u1F310' },
        { path: '/api/operations/termination-grace-tracker', name: 'Term Grace', icon: '\u23F1' },
        { path: '/api/operations/kubelet-pleg-latency', name: 'PLEG Latency', icon: '\u1F4C8' },
        { path: '/api/security/sa-token-mount-risk', name: 'SA Token Mount', icon: '\u1F511' },
        { path: '/api/security/cr-binding-explosion', name: 'CR Binding', icon: '\u1F465' },
        { path: '/api/security/container-port-exposure', name: 'Port Exposure', icon: '\u1F50C' },
        { path: '/api/docs/namespace-catalog', name: 'NS Catalog', icon: '\u1F4D2' },
        { path: '/api/docs/limit-range-doc', name: 'LimitRange Doc', icon: '\u1F4D1' },
        { path: '/api/docs/event-freq-heatmap', name: 'Event Heatmap', icon: '\u1F525' },
        { path: '/api/scalability/control-plane-pressure', name: 'Ctrl Plane', icon: '\u1F3D7' },
        { path: '/api/scalability/etcd-size-forecast', name: 'Etcd Forecast', icon: '\u1F4BE' },
        ...
        { path: '/api/operations/log-volume-anomaly', name: 'Log Anomaly', icon: '\u1F4DD' },
        ...
        { path: '/api/scalability/node-pool-diversification', name: 'Node Pool', icon: '\u1F5FA' },
        { path: '/api/scalability/csi-driver-capacity', name: 'CSI Driver', icon: '\u1F4BE' },
        { path: '/api/product/owner-ref-audit', name: 'Owner Ref', icon: '\u1F465' },
        { path: '/api/product/svc-type-compliance', name: 'Svc Type', icon: '\u1F310' },
        { path: '/api/product/res-gap-analyzer', name: 'Res Gap', icon: '\u1F4CF' },
        { path: '/api/deployment/sts-update-compliance', name: 'STS Update', icon: '\u1F501' },
        { path: '/api/deployment/dns-policy-audit-v2050', name: 'DNS Policy v2', icon: '\u1F310' },
        { path: '/api/deployment/cmd-args-standard', name: 'Cmd Args', icon: '\u1F4BB' },
        { path: '/api/operations/kube-proxy-health-v2051', name: 'Kube Proxy v2', icon: '\u1F310' },
        { path: '/api/operations/cni-plugin-audit', name: 'CNI Plugin', icon: '\u1F3A7' },
        { path: '/api/operations/storage-op-latency', name: 'Stor Op Latency', icon: '\u1F4BF' },
        { path: '/api/security/secret-data-volume-audit', name: 'Secret Vol Audit', icon: '\u1F510' },
        { path: '/api/security/default-deny-check', name: 'Default Deny', icon: '\u1F6E1' },
        { path: '/api/security/webhook-risk-audit', name: 'Webhook Risk', icon: '\u26A0' },
        { path: '/api/docs/age-timeline', name: 'Age Timeline', icon: '\u1F4C5' },
        ...
        { path: '/api/product/registry-diversity', name: 'Reg Diversity', icon: '\u1F4E6' },
        { path: '/api/product/ingress-backend-health', name: 'Ing Backend', icon: '\u1F310' },
        { path: '/api/product/pvc-lifecycle', name: 'PVC Lifecycle', icon: '\u1F4BF' },
        { path: '/api/deployment/condition-drift', name: 'Cond Drift', icon: '\u1F501' },
        { path: '/api/deployment/pss-validator', name: 'PSS Validator', icon: '\u1F6E1' },
        { path: '/api/deployment/resource-equality', name: 'Res Equality', icon: '\u1F4CF' },
        { path: '/api/operations/oom-risk-predictor', name: 'OOM Risk', icon: '\u26A0' },
        { path: '/api/operations/api-server-qps', name: 'API QPS', icon: '\u1F4C8' },
        { path: '/api/operations/node-pressure-score', name: 'Node Pressure', icon: '\u1F534' },
        { path: '/api/security/secret-age-tracker', name: 'Secret Age', icon: '\u1F510' },
        { path: '/api/security/rbac-binding-audit', name: 'RBAC Binding', icon: '\u1F465' },
        { path: '/api/security/escalation-surface', name: 'Esc Surface', icon: '\u26A0' },
        { path: '/api/docs/svc-port-mapping-v2059', name: 'Svc Ports v2', icon: '\u1F50C' },
        { path: '/api/docs/taint-effect-catalog-v2059', name: 'Taint Effect v2', icon: '\u26D4' },
        { path: '/api/docs/cm-key-inventory-v2059', name: 'CM Keys v2', icon: '\u1F4DD' },
        { path: '/api/scalability/replica-availability-budget', name: 'Replica Avail', icon: '\u1F465' },
        { path: '/api/scalability/workload-distribution-score', name: 'Wkld Dist', icon: '\u1F4CA' },
        { path: '/api/scalability/failover-readiness-v2060', name: 'Failover Ready v2', icon: '\u1F6E1' },
        { path: '/api/product/image-cache-hit', name: 'Image Cache', icon: '\u1F4BE' },
        { path: '/api/product/endpoint-health-distribution', name: 'EP Health', icon: '\u2705' },
        { path: '/api/product/ns-cost-allocation', name: 'NS Cost', icon: '\u1F4B0' },
        { path: '/api/deployment/generation-tracker', name: 'Gen Tracker', icon: '\u1F4C8' },
        { path: '/api/deployment/stdin-toggle-audit', name: 'Stdin Toggle', icon: '\u2328' },
        { path: '/api/deployment/spread-constraint-audit-v2062', name: 'Spread Audit v2', icon: '\u1F310' },
        { path: '/api/operations/pod-ready-latency-v2063', name: 'Ready Latency v2', icon: '\u23F1' },
        { path: '/api/operations/restart-velocity', name: 'Restart Velocity', icon: '\u1F501' },
        { path: '/api/operations/event-noise-filter-v2063', name: 'Event Noise v2', icon: '\u1F50A' },
        { path: '/api/security/cap-drop-audit-v2064', name: 'Cap Drop v2', icon: '\u1F6E1' },
        { path: '/api/security/seccomp-coverage-v2064', name: 'Seccomp v2', icon: '\u1F6E1' },
        { path: '/api/security/ns-isolation-score', name: 'NS Isolation', icon: '\u1F512' },
        { path: '/api/docs/pv-reclaim-catalog-v2065', name: 'PV Reclaim v2', icon: '\u1F4BF' },
        { path: '/api/docs/sa-inventory-v2065', name: 'SA Inv v2', icon: '\u1F511' },
        { path: '/api/docs/node-condition-timeline-v2065', name: 'Node Cond TL v2', icon: '\u1F550' },
        { path: '/api/scalability/hpa-thrash-detect', name: 'HPA Thrash', icon: '\u1F4C8' },
        { path: '/api/scalability/eviction-readiness', name: 'Evict Ready', icon: '\u1F6E1' },
        { path: '/api/scalability/cluster-scaling-headroom', name: 'Scale Headroom', icon: '\u1F4CF' },
        { path: '/api/product/wkld-density-profile', name: 'Wkld Density', icon: '\u1F4CA' },
        { path: '/api/product/image-vintage-tracker', name: 'Img Vintage', icon: '\u1F4D6' },
        { path: '/api/product/svc-protocol-distribution', name: 'Svc Protocol', icon: '\u1F310' },
        { path: '/api/deployment/rolling-window-inspector-v2068', name: 'Rolling Window v2', icon: '\u1F4C8' },
        { path: '/api/deployment/preemption-tracker', name: 'Preempt Track', icon: '\u26A1' },
        { path: '/api/deployment/sts-partition-audit', name: 'STS Partition', icon: '\u1F4CF' },
        { path: '/api/operations/cpu-saturation', name: 'CPU Saturation', icon: '\u1F525' },
        { path: '/api/operations/mem-wset-estimate', name: 'Mem WSet', icon: '\u1F4BE' },
        { path: '/api/operations/startup-phase-tracker', name: 'Startup Phase', icon: '\u23F1' },
        { path: '/api/security/secret-type-audit-v2070', name: 'Secret Type v2', icon: '\u1F510' },
        { path: '/api/security/sa-privilege-analysis', name: 'SA Privilege', icon: '\u1F451' },
        { path: '/api/security/runas-user-validator', name: 'RunAsUser', icon: '\u1F6E1' },
        { path: '/api/docs/sc-provisioner-map-v2071', name: 'SC Provisioner v2', icon: '\u1F4BF' },
        { path: '/api/docs/ns-annotation-standard-v2071', name: 'NS Annot Std v2', icon: '\u1F4DD' },
        { path: '/api/docs/crd-conversion-strategy', name: 'CRD Conversion', icon: '\u1F504' },
        { path: '/api/scalability/pod-distribution-balance', name: 'Pod Balance', icon: '\u1F4CA' },
        { path: '/api/scalability/request-saturation-v2072', name: 'Req Saturation v2', icon: '\u1F4CF' },
        { path: '/api/scalability/volume-attachment-spread', name: 'Vol Attach', icon: '\u1F4BF' },
        { path: '/api/product/affinity-catalog-v2073', name: 'Affinity Cat v2', icon: '\u1F517' },
        { path: '/api/product/ingress-tls-coverage', name: 'Ing TLS Cover', icon: '\u1F510' },
        { path: '/api/product/configmap-rotation-tracker', name: 'CM Rotation', icon: '\u1F504' },
        { path: '/api/deployment/progress-deadline-audit', name: 'Progress Deadline', icon: '\u23F1' },
        { path: '/api/deployment/workdir-validator', name: 'WorkDir Valid', icon: '\u1F4C2' },
        { path: '/api/deployment/rs-orphan-detect', name: 'RS Orphan', icon: '\u1F4E6' },
        { path: '/api/operations/crash-pattern-detect', name: 'Crash Pattern', icon: '\u1F534' },
        { path: '/api/operations/pull-time-estimate-v2075', name: 'Pull Time v2', icon: '\u2B07' },
        { path: '/api/operations/allocatable-efficiency-v2075', name: 'Alloc Eff v2', icon: '\u1F4CF' },
        { path: '/api/security/privileged-inventory-v2076', name: 'Priv Inv v2', icon: '\u26A0' },
        { path: '/api/security/volume-permission-audit', name: 'Vol Perm', icon: '\u1F4BF' },
        { path: '/api/security/clusterrole-aggregation', name: 'CR Aggregation', icon: '\u1F465' },
        { path: '/api/docs/pod-ip-inventory-v2077', name: 'Pod IP Inv', icon: '\u1F310' },
        { path: '/api/docs/node-os-catalog-v2077', name: 'Node OS v2', icon: '\u1F4BB' },
        { path: '/api/docs/external-ip-tracker', name: 'Ext IP Track', icon: '\u1F310' },
        { path: '/api/scalability/scheduling-score-v2078', name: 'Sched Score v2', icon: '\u23F1' },
        { path: '/api/scalability/fragmentation-analysis-v2078', name: 'Fragmentation v2', icon: '\u1F4CA' },
        { path: '/api/scalability/multizone-ha-validator', name: 'Multi-Zone HA', icon: '\u1F310' },
        { path: '/api/product/topo-pin-analysis-v2079', name: 'Topo Pin', icon: '\u1F4CD' },
        { path: '/api/product/ingress-rule-complexity', name: 'Ing Rule Complex', icon: '\u1F4C8' },
        { path: '/api/product/storage-access-mode-coverage', name: 'Access Mode', icon: '\u1F4BF' },
        { path: '/api/deployment/vc-claim-audit-v2080', name: 'VC Claim Audit', icon: '\u1F4BF' },
        { path: '/api/deployment/ds-update-compliance-v2080', name: 'DS Update', icon: '\u1F4E6' },
        { path: '/api/deployment/history-depth-v2080', name: 'History Depth', icon: '\u1F4DC' },
        { path: '/api/operations/pod-phase-distribution-v2081', name: 'Phase Dist v2', icon: '\u1F4CA' },
        { path: '/api/operations/kubelet-version-drift-v2081', name: 'KV Drift', icon: '\u1F4BB' },
        ...
        { path: '/api/security/audit-log-config-v2082', name: 'Audit Log', icon: '\u1F4DD' },
        { path: '/api/security/certificate-age-tracker-v2082', name: 'Cert Age v2', icon: '\u1F4DC' },
        { path: '/api/docs/node-arch-map-v2083', name: 'Node Arch v2', icon: '\u1F578' },
        { path: '/api/docs/event-age-distribution-v2083', name: 'Event Age v2', icon: '\u1F550' },
        { path: '/api/docs/clusterip-range-usage-v2083', name: 'ClusterIP Usage', icon: '\u1F310' },
        { path: '/api/scalability/capacity-trend-v2084', name: 'Cap Trend v2', icon: '\u1F4C8' },
        { path: '/api/scalability/pod-density-forecast-v2084', name: 'Pod Forecast v2', icon: '\u1F4C8' },
        { path: '/api/scalability/ha-coverage-v2084', name: 'HA Coverage', icon: '\u1F6E1' },
        { path: '/api/product/grace-shutdown-v2085', name: 'Grace Shutdown', icon: '\u23F1' },
        { path: '/api/product/mesh-readiness-v2085', name: 'Mesh Ready', icon: '\u1F3D7' },
        { path: '/api/product/snapshot-retention-v2085', name: 'Snap Retention', icon: '\u1F4F7' },
        { path: '/api/deployment/res-gap-wide-v2086', name: 'Res Gap Wide', icon: '\u1F4CF' },
        { path: '/api/deployment/qos-distribution-v2086', name: 'QoS Dist', icon: '\u1F4CA' },
        { path: '/api/deployment/revision-staleness-v2086', name: 'Rev Stale', icon: '\u1F4DC' },
        { path: '/api/operations/restart-trend-v2087', name: 'Restart Trend', icon: '\u1F501' },
        ...
        { path: '/api/security/sa-token-age-v2088', name: 'SA Token Age', icon: '\u1F511' },
        ...
        { path: '/api/docs/node-capacity-summary-v2089', name: 'Node Cap Sum', icon: '\u1F4BE' },
        { path: '/api/docs/secret-key-count-v2089', name: 'Secret Keys', icon: '\u1F510' },
        { path: '/api/docs/quota-catalog-v2089', name: 'Quota Catalog', icon: '\u1F4B0' },
        { path: '/api/scalability/sched-latency-v2090', name: 'Sched Latency', icon: '\u23F1' },
        { path: '/api/scalability/overcommit-ratio-v2090', name: 'Overcommit', icon: '\u1F4C8' },
        { path: '/api/scalability/pod-density-histogram-v2090', name: 'Pod Density', icon: '\u1F4CA' },
        { path: '/api/product/label-compliance-v2091', name: 'Label Compliance', icon: '\u1F3F7' },
        { path: '/api/product/port-collision-v2091', name: 'Port Collision', icon: '\u26A0' },
        { path: '/api/product/restart-budget-v2091', name: 'Restart Budget', icon: '\u1F501' },
        { path: '/api/deployment/sts-ordinal-v2092', name: 'STS Ordinal', icon: '\u1F522' },
        { path: '/api/deployment/ds-selector-coverage-v2092', name: 'DS Selector', icon: '\u1F50D' },
        { path: '/api/deployment/env-var-consistency-v2092', name: 'Env Consistency', icon: '\u1F4DD' },
        { path: '/api/operations/image-size-estimate-v2093', name: 'Img Size Est', icon: '\u1F4BE' },
        ...
        { path: '/api/security/secret-exposure-v2094', name: 'Secret Exposure', icon: '\u1F510' },
        { path: '/api/security/wildcard-rbac-v2094', name: 'Wildcard RBAC', icon: '\u2728' },
        { path: '/api/security/fsgroup-validator-v2094', name: 'fsGroup Valid', icon: '\u1F465' },
        { path: '/api/docs/bind-mode-catalog-v2095', name: 'Bind Mode', icon: '\u1F4BF' },
        { path: '/api/docs/kernel-version-map-v2095', name: 'Kernel Map', icon: '\u1F4BB' },
        { path: '/api/docs/session-affinity-catalog-v2095', name: 'Session Affinity', icon: '\u1F517' },
        { path: '/api/scalability/limit-coverage-v2096', name: 'Limit Coverage', icon: '\u1F4CF' },
        { path: '/api/scalability/node-failure-impact-v2096', name: 'Node Fail Impact', icon: '\u1F534' },
        { path: '/api/scalability/pvc-storage-distribution-v2096', name: 'PVC Storage Dist', icon: '\u1F4BF' },
        { path: '/api/product/wait-reason-v2097', name: 'Wait Reason', icon: '\u23F3' },
        { path: '/api/product/epslice-count-v2097', name: 'EP Slice Cnt', icon: '\u1F5FA' },
        { path: '/api/product/lifecycle-hook-v2097', name: 'Lifecycle Hook', icon: '\u1F501' },
        { path: '/api/deployment/paused-status-v2098', name: 'Paused Status', icon: '\u23F8' },
        { path: '/api/deployment/topo-spread-v2098', name: 'Topo Spread v2', icon: '\u1F310' },
        { path: '/api/deployment/secctx-completeness-v2098', name: 'SecCtx Complete', icon: '\u1F6E1' },
        { path: '/api/operations/ctnr-state-v2099', name: 'Ctnr State', icon: '\u1F4CA' },
        { path: '/api/operations/runtime-map-v2099', name: 'Runtime Map', icon: '\u1F4BB' },
        { path: '/api/operations/qos-eviction-risk-v2099', name: 'QoS Eviction', icon: '\u26A0' },
        { path: '/api/security/np-empty-selector-v2100', name: 'NP Empty Sel', icon: '\u1F310' },
        { path: '/api/security/host-alias-v2100', name: 'Host Alias', icon: '\u1F4BB' },
        { path: '/api/security/secret-mount-path-v2100', name: 'Secret Mount', icon: '\u1F510' },
        { path: '/api/docs/boot-id-catalog-v2101', name: 'Boot ID', icon: '\u1F4BB' },
        { path: '/api/docs/svc-type-histogram-v2101', name: 'Svc Type Hist', icon: '\u1F4CA' },
        { path: '/api/docs/dns-config-catalog-v2101', name: 'DNS Config', icon: '\u1F310' },
        { path: '/api/scalability/antiaff-effectiveness-v2102', name: 'AntiAff Eff', icon: '\u1F310' },
        { path: '/api/scalability/cpu-request-waste-v2102', name: 'CPU Waste', icon: '\u1F4C8' },
        { path: '/api/scalability/ns-quota-headroom-v2102', name: 'NS Quota HR', icon: '\u1F4CF' },
        { path: '/api/product/startup-probe-v2103', name: 'Startup Probe', icon: '\u1F50D' },
        { path: '/api/product/ext-traffic-policy-v2103', name: 'Ext Traffic', icon: '\u1F310' },
        { path: '/api/product/ns-finalizer-v2103', name: 'NS Finalizer', icon: '\u1F527' },
        { path: '/api/deployment/strategy-validator-v2104', name: 'Strategy Valid', icon: '\u1F501' },
        { path: '/api/deployment/sts-svc-binding-v2104', name: 'STS Svc Binding', icon: '\u1F517' },
        { path: '/api/deployment/ds-toleration-v2104', name: 'DS Toleration', icon: '\u26D4' },
        { path: '/api/operations/alloc-pod-ratio-v2105', name: 'Alloc Pod Ratio', icon: '\u1F4CA' },
        { path: '/api/operations/ctnr-count-dist-v2105', name: 'Ctnr Count', icon: '\u1F522' },
        { path: '/api/operations/event-source-dist-v2105', name: 'Event Source', icon: '\u1F4E1' },
        { path: '/api/security/sa-token-mount-v2106', name: 'SA Token Mount', icon: '\u1F511' },
        { path: '/api/security/volume-projection-v2106', name: 'Vol Projection', icon: '\u1F4BF' },
        { path: '/api/security/crb-subject-type-v2106', name: 'CRB Subject', icon: '\u1F465' },
        { path: '/api/docs/pvc-sc-distribution-v2107', name: 'PVC SC Dist', icon: '\u1F4BF' },
        { path: '/api/docs/runtime-version-map-v2107', name: 'Runtime Ver Map', icon: '\u1F4BB' },
        { path: '/api/docs/restart-policy-catalog-v2107', name: 'Restart Policy', icon: '\u1F501' },
        { path: '/api/scalability/mem-efficiency-v2108', name: 'Mem Efficiency', icon: '\u1F4BE' },
        { path: '/api/scalability/pod-ip-allocation-v2108', name: 'Pod IP Alloc', icon: '\u1F310' },
        { path: '/api/scalability/replica-concentration-v2108', name: 'Replica Conc', icon: '\u1F465' },
        { path: '/api/product/subresource-inventory-v2109', name: 'Subresource Inv', icon: '\u1F4E6' },
        { path: '/api/product/ingress-annot-compliance-v2109', name: 'Ing Annot', icon: '\u1F4DD' },
        { path: '/api/product/ns-pod-capacity-ratio-v2109', name: 'NS Pod Cap', icon: '\u1F4CF' },
        { path: '/api/deployment/readiness-gate-v2110', name: 'Ready Gate', icon: '\u2705' },
        { path: '/api/deployment/pdb-min-available-v2110', name: 'PDB Min Avail', icon: '\u1F6E1' },
        { path: '/api/deployment/image-digest-pinning-v2110', name: 'Img Digest', icon: '\u1F510' },
        ...
        { path: '/api/operations/vol-mount-count-v2111', name: 'Vol Mount Cnt', icon: '\u1F4BF' },
        { path: '/api/security/sa-pullsecret-v2112', name: 'SA PullSecret', icon: '\u1F511' },
        { path: '/api/security/runas-nonroot-v2112', name: 'runAsNonRoot', icon: '\u1F6E1' },
        { path: '/api/security/secret-immutable-v2112', name: 'Secret Immutable', icon: '\u1F512' },
        { path: '/api/docs/label-diversity-v2113', name: 'Label Diversity', icon: '\u1F3F7' },
        { path: '/api/docs/port-name-inventory-v2113', name: 'Port Name Inv', icon: '\u1F50C' },
        { path: '/api/docs/annot-key-distribution-v2113', name: 'Annot Key Dist', icon: '\u1F4DD' },
        { path: '/api/scalability/cpu-burst-headroom-v2114', name: 'CPU Burst HR', icon: '\u1F525' },
        { path: '/api/scalability/pod-spread-evenness-v2114', name: 'Pod Spread Even', icon: '\u1F310' },
        { path: '/api/scalability/ns-resource-footprint-v2114', name: 'NS Footprint', icon: '\u1F4B0' },
        { path: '/api/product/priority-class-v2115', name: 'Priority Class', icon: '\u26A1' },
        { path: '/api/product/sa-token-volume-v2115', name: 'SA Token Vol', icon: '\u1F511' },
        { path: '/api/product/rev-history-limit-v2115', name: 'Rev History Lim', icon: '\u1F4DC' },
        { path: '/api/deployment/probe-timeout-v2116', name: 'Probe Timeout', icon: '\u23F1' },
        { path: '/api/deployment/init-resource-v2116', name: 'Init Resource', icon: '\u1F4CF' },
        { path: '/api/deployment/max-unavailable-v2116', name: 'Max Unavail', icon: '\u26A0' },
        { path: '/api/operations/machine-info-v2117', name: 'Machine Info', icon: '\u1F4BB' },
        { path: '/api/operations/exit-code-dist-v2117', name: 'Exit Code Dist', icon: '\u1F534' },
        { path: '/api/operations/lb-health-v2117', name: 'LB Health', icon: '\u2705' },
        { path: '/api/security/supp-group-v2118', name: 'Supp Group', icon: '\u1F465' },
        { path: '/api/security/default-sa-priv-v2118', name: 'Default SA Priv', icon: '\u26A0' },
        { path: '/api/security/np-ingress-complexity-v2118', name: 'NP Ingress Cmplx', icon: '\u1F310' },
        { path: '/api/docs/node-allocatable-v2119', name: 'Node Allocatable', icon: '\u1F4BE' },
        { path: '/api/docs/pvc-phase-dist-v2119', name: 'PVC Phase Dist', icon: '\u1F4BF' },
        { path: '/api/docs/toleration-catalog-v2119', name: 'Toleration Catalog', icon: '\u26D4' },
        { path: '/api/scalability/mem-limit-alloc-v2120', name: 'Mem Limit Alloc', icon: '\u1F4BE' },
        { path: '/api/scalability/ns-quartile-v2120', name: 'NS Quartile', icon: '\u1F4CA' },
        { path: '/api/scalability/blast-radius-v2120', name: 'Blast Radius', icon: '\u1F534' },
        { path: '/api/product/term-grace-v2121', name: 'Term Grace', icon: '\u23F1' },
        { path: '/api/product/int-traffic-policy-v2121', name: 'Int Traffic', icon: '\u1F310' },
        { path: '/api/product/ns-age-distribution-v2121', name: 'NS Age Dist', icon: '\u1F4C5' },
        { path: '/api/deployment/os-selector-v2122', name: 'OS Selector', icon: '\u1F4BB' },
        { path: '/api/deployment/lim-req-ratio-v2122', name: 'Lim Req Ratio', icon: '\u1F4CF' },
        { path: '/api/deployment/surge-efficiency-v2122', name: 'Surge Eff', icon: '\u1F4C8' },
        { path: '/api/operations/qos-guaranteed-v2123', name: 'QoS Guaranteed', icon: '\u2705' },
        { path: '/api/operations/kp-version-map-v2123', name: 'KP Version', icon: '\u1F4BB' },
        { path: '/api/operations/vol-device-path-v2123', name: 'Vol Device', icon: '\u1F4BF' },
        { path: '/api/security/sysctl-validator-v2124', name: 'Sysctl Valid', icon: '\u2699' },
        { path: '/api/security/psa-level-v2124', name: 'PSA Level', icon: '\u1F6E1' },
        { path: '/api/security/cr-verbs-resource-v2124', name: 'CR Verbs Res', icon: '\u1F465' },
        { path: '/api/docs/feature-label-v2125', name: 'Feature Label', icon: '\u1F3F7' },
        { path: '/api/docs/sa-mapping-v2125', name: 'SA Mapping', icon: '\u1F511' },
        { path: '/api/docs/cm-immutable-v2125', name: 'CM Immutable', icon: '\u1F512' },
        { path: '/api/scalability/cpu-throttle-risk-v2126', name: 'CPU Throttle', icon: '\u1F525' },
        { path: '/api/scalability/pvc-reclaim-waste-v2126', name: 'PVC Waste', icon: '\u1F4BF' },
        { path: '/api/scalability/ns-replica-spread-v2126', name: 'NS Replica', icon: '\u1F465' },
        { path: '/api/product/active-deadline-v2127', name: 'Active Deadline', icon: '\u23F1' },
        { path: '/api/product/ip-family-dist-v2127', name: 'IP Family', icon: '\u1F310' },
        { path: '/api/product/label-diversity-score-v2127', name: 'Label Div Score', icon: '\u1F3F7' },
        { path: '/api/deployment/res-delta-v2128', name: 'Res Delta', icon: '\u1F4CF' },
        { path: '/api/deployment/evict-multiplier-v2128', name: 'Evict Mult', icon: '\u1F6E1' },
        { path: '/api/deployment/ctnr-restart-budget-v2128', name: 'Ctnr Restart Bud', icon: '\u1F501' },
        { path: '/api/operations/alloc-eff-ratio-v2129', name: 'Alloc Eff Ratio', icon: '\u1F4CA' },
        { path: '/api/operations/restart-avg-v2129', name: 'Restart Avg', icon: '\u1F4C8' },
        { path: '/api/operations/port-range-dist-v2129', name: 'Port Range', icon: '\u1F50C' },
        { path: '/api/security/host-pid-ipc-v2130', name: 'Host PID/IPC', icon: '\u26A0' },
        { path: '/api/security/sa-automount-v2130', name: 'SA Automount', icon: '\u1F511' },
        { path: '/api/security/np-coverage-ratio-v2130', name: 'NP Coverage', icon: '\u1F310' },
        { path: '/api/docs/event-reason-top-v2131', name: 'Event Reason Top', icon: '\u1F4CB' },
        { path: '/api/docs/instance-type-v2131', name: 'Instance Type', icon: '\u1F4BB' },
        { path: '/api/docs/pv-reclaim-diversity-v2131', name: 'PV Reclaim Div', icon: '\u1F4BF' },
        { path: '/api/scalability/mem-eff-ns-v2132', name: 'Mem Eff NS', icon: '\u1F4BE' },
        { path: '/api/scalability/density-risk-v2132', name: 'Density Risk', icon: '\u26A0' },
        { path: '/api/scalability/hpa-target-match-v2132', name: 'HPA Target Match', icon: '\u1F4C8' },
        { path: '/api/product/sa-override-v2133', name: 'SA Override', icon: '\u1F511' },
        { path: '/api/product/ingress-path-type-v2133', name: 'Ing Path Type', icon: '\u1F517' },
        { path: '/api/product/pvc-finalizer-v2133', name: 'PVC Finalizer', icon: '\u1F4BF' },
        { path: '/api/deployment/scheduler-name-v2134', name: 'Scheduler Name', icon: '\u2699' },
        { path: '/api/deployment/stdin-tty-v2134', name: 'Stdin TTY', icon: '\u2328' },
        { path: '/api/deployment/replica-range-v2134', name: 'Replica Range', icon: '\u1F4CF' },
        { path: '/api/operations/node-trans-v2135', name: 'Node Trans', icon: '\u2705' },
        { path: '/api/operations/ctnr-age-v2135', name: 'Ctnr Age', icon: '\u1F4C5' },
        { path: '/api/operations/ep-ready-ratio-v2135', name: 'EP Ready Ratio', icon: '\u1F4CA' },
        { path: '/api/security/hostpath-write-v2136', name: 'HostPath Write', icon: '\u26A0' },
        { path: '/api/security/psa-priv-v2136', name: 'PSA Priv', icon: '\u26A0' },
        { path: '/api/security/sa-secret-ref-v2136', name: 'SA Secret Ref', icon: '\u1F510' },
        { path: '/api/docs/provider-id-v2137', name: 'Provider ID', icon: '\u1F4BB' },
        { path: '/api/docs/crd-scope-v2137', name: 'CRD Scope', icon: '\u1F4C2' },
        { path: '/api/docs/lb-class-v2137', name: 'LB Class', icon: '\u1F310' },
        { path: '/api/scalability/cpu-overcommit-node-v2138', name: 'CPU Overcommit Node', icon: '\u1F525' },
        { path: '/api/scalability/bin-pack-score-v2138', name: 'Bin Pack Score', icon: '\u1F4E6' },
        { path: '/api/scalability/ns-ha-multiplier-v2138', name: 'NS HA Mult', icon: '\u1F6E1' },
        { path: '/api/product/dns-policy-v2139', name: 'DNS Policy', icon: '\u1F310' },
        { path: '/api/product/oversubscription-v2139', name: 'Oversubscription', icon: '\u1F4CF' },
        { path: '/api/product/publish-notready-v2139', name: 'Pub NotReady', icon: '\u26A0' },
        { path: '/api/deployment/hostname-fqdn-v2140', name: 'Hostname FQDN', icon: '\u1F4BB' },
        { path: '/api/deployment/workdir-overlap-v2140', name: 'WorkDir Overlap', icon: '\u1F4C2' },
        { path: '/api/deployment/owner-ref-v2140', name: 'Owner Ref', icon: '\u1F517' },
        { path: '/api/operations/cond-chron-v2141', name: 'Cond Chron', icon: '\u1F4CA' },
        { path: '/api/operations/phase-rate-v2141', name: 'Phase Rate', icon: '\u1F504' },
        { path: '/api/operations/evt-obj-type-v2141', name: 'Evt Obj Type', icon: '\u1F4E1' },
        { path: '/api/security/selinux-v2142', name: 'SELinux', icon: '\u1F6E1' },
        { path: '/api/security/rbac-per-ns-v2142', name: 'RBAC Per NS', icon: '\u1F465' },
        { path: '/api/security/secret-type-enf-v2142', name: 'Secret Type Enf', icon: '\u1F510' },
        { path: '/api/docs/node-addr-v2143', name: 'Node Addr', icon: '\u1F4CD' },
        { path: '/api/docs/pvc-source-v2143', name: 'PVC Source', icon: '\u1F4BF' },
        { path: '/api/docs/pod-subdomain-v2143', name: 'Pod Subdomain', icon: '\u1F310' },
        { path: '/api/scalability/cpu-quartile-v2144', name: 'CPU Quartile', icon: '\u1F4CA' },
        { path: '/api/scalability/pvc-overhead-v2144', name: 'PVC Overhead', icon: '\u1F4BF' },
        { path: '/api/scalability/ns-forecast-v2144', name: 'NS Forecast', icon: '\u1F4C8' },
        { path: '/api/product/pod-overhead-v2145', name: 'Pod Overhead', icon: '\u1F4CF' },
        { path: '/api/product/stdin-once-v2145', name: 'Stdin Once', icon: '\u2328' },
        { path: '/api/product/alloc-lb-nodeports-v2145', name: 'Alloc LB NP', icon: '\u1F310' },
        { path: '/api/deployment/ephemeral-v2146', name: 'Ephemeral', icon: '\u1F501' },
        { path: '/api/deployment/min-ready-v2146', name: 'Min Ready', icon: '\u2705' },
        { path: '/api/deployment/pullsecret-cov-v2146', name: 'PullSecret Cov', icon: '\u1F510' },
        ...
        { path: '/api/operations/evt-freshness-v2147', name: 'Evt Freshness', icon: '\u1F550' },
        { path: '/api/security/readonly-rootfs-v2148', name: 'RO RootFS', icon: '\u1F512' },
        { path: '/api/security/crb-agg-count-v2148', name: 'CRB Agg Count', icon: '\u1F465' },
        { path: '/api/security/sa-annot-secret-v2148', name: 'SA Annot Secret', icon: '\u1F511' },
        { path: '/api/docs/cap-alloc-gap-v2149', name: 'Cap Alloc Gap', icon: '\u1F4BE' },
        { path: '/api/docs/pvc-volname-v2149', name: 'PVC VolName', icon: '\u1F4BF' },
        { path: '/api/docs/pod-hostname-v2149', name: 'Pod Hostname', icon: '\u1F4BB' },
        { path: '/api/scalability/mem-forecast-v2150', name: 'Mem Forecast', icon: '\u1F4BE' },
        { path: '/api/scalability/topo-key-cov-v2150', name: 'Topo Key Cov', icon: '\u1F310' },
        { path: '/api/scalability/ns-cpu-quota-v2150', name: 'NS CPU Quota', icon: '\u1F525' },
        { path: '/api/product/share-proc-ns-v2151', name: 'Share ProcNS', icon: '\u1F501' },
        { path: '/api/product/term-msg-policy-v2151', name: 'Term Msg Policy', icon: '\u1F4DD' },
        { path: '/api/product/app-protocol-v2151', name: 'AppProtocol', icon: '\u1F310' },
        { path: '/api/deployment/node-sel-req-v2152', name: 'Node Sel Req', icon: '\u1F4CD' },
        { path: '/api/deployment/img-vol-mount-v2152', name: 'Img Vol Mount', icon: '\u1F4BE' },
        { path: '/api/deployment/dep-cond-v2152', name: 'Dep Cond', icon: '\u2705' },
        { path: '/api/operations/sys-info-v2153', name: 'Sys Info', icon: '\u1F4BB' },
        { path: '/api/operations/besteffort-v2153', name: 'BestEffort', icon: '\u26A0' },
        { path: '/api/operations/vol-name-cons-v2153', name: 'Vol Name Cons', icon: '\u1F4BF' },
        { path: '/api/security/seccomp-type-v2154', name: 'Seccomp Type', icon: '\u1F6E1' },
        { path: '/api/security/default-deny-v2154', name: 'Default Deny', icon: '\u1F310' },
        { path: '/api/security/cr-wild-verb-v2154', name: 'CR Wild Verb', icon: '\u2728' },
        { path: '/api/docs/taint-key-v2155', name: 'Taint Key', icon: '\u26D4' },
        { path: '/api/docs/pvc-default-sc-v2155', name: 'PVC Default SC', icon: '\u1F4BF' },
        { path: '/api/docs/rest-pol-owner-v2155', name: 'Rest Pol Owner', icon: '\u1F501' },
        { path: '/api/scalability/cpu-conc-v2156', name: 'CPU Conc', icon: '\u1F525' },
        { path: '/api/scalability/aff-cost-v2156', name: 'Aff Cost', icon: '\u1F4C8' },
        { path: '/api/scalability/ns-multi-ha-v2156', name: 'NS Multi HA', icon: '\u1F6E1' },
        { path: '/api/product/priority-class-v2115', name: 'Priority Class', icon: '\u26A1' },

        { path: '/api/docs/annotation-report', name: 'Annot Report', icon: '\u1F4DD' },
        { path: '/api/docs/topology-map-v2', name: 'Topology Map v2', icon: '\u1F5FA' },
        { path: '/api/docs/storage-attachment-inv', name: 'Storage Attach', icon: '\u1F4BF' },
        { path: '/api/docs/port-catalog', name: 'Port Catalog', icon: '\u1F50C' },
        { path: '/api/docs/rbac-cheatsheet', name: 'RBAC Cheatsheet', icon: '\u1F511' },
        { path: '/api/docs/cluster-blueprint', name: 'Cluster Blueprint', icon: '\u1F3D7' },
        { path: '/api/docs/ingress-catalog', name: 'Ingress Catalog', icon: '\u1F310' },
        { path: '/api/docs/network-policy-catalog', name: 'NetPol Catalog', icon: '\u1F6E1' },
        { path: '/api/docs/label-inventory', name: 'Label Inventory', icon: '\u1F3F7' },
        { path: '/api/docs/configmap-catalog', name: 'CM Catalog', icon: '\u1F4DD' },
        { path: '/api/docs/hpa-catalog', name: 'HPA Catalog', icon: '\u2195' },
        { path: '/api/docs/pdb-catalog', name: 'PDB Catalog', icon: '\u1F6E1' },
        { path: '/api/docs/secret-inventory', name: 'Secret Inv', icon: '\u1F512' },
        { path: '/api/docs/service-account-inventory', name: 'SA Inv', icon: '\u1F464' },
        { path: '/api/docs/event-type-catalog', name: 'Event Types', icon: '\u1F4CB' },
        { path: '/api/docs/node-taint-catalog', name: 'Taint Catalog', icon: '\u26D4' },
        { path: '/api/docs/volume-snapshot-catalog', name: 'Snap Catalog', icon: '\u1F4F7' },
        { path: '/api/docs/storage-class-catalog', name: 'SC Catalog', icon: '\u1F4BE' },
        { path: '/api/docs/priority-class-catalog', name: 'PC Catalog', icon: '\u26A1' },
        { path: '/api/docs/role-binding-catalog', name: 'RB Catalog', icon: '\u1F511' },
        { path: '/api/docs/endpoint-slice-catalog', name: 'EP Slice', icon: '\u1F310' },
        { path: '/api/docs/topology-spread-catalog', name: 'Topo Spread', icon: '\u1F5FA' },
        { path: '/api/docs/limitrange-catalog', name: 'LimitRange', icon: '\u2696' },
        { path: '/api/docs/lease-holder-catalog', name: 'Lease Catalog', icon: '\u1F527' },
        { path: '/api/docs/runtime-class-inventory', name: 'RC Inv', icon: '\u1F9E9' },
        { path: '/api/docs/ingress-backend-catalog', name: 'Ing Backend', icon: '\u1F310' },
        { path: '/api/docs/csi-driver-inventory', name: 'CSI Driver', icon: '\u1F4BE' },
        { path: '/api/docs/pod-disruption-coverage', name: 'PDB Coverage', icon: '\u1F6E1' },
        { path: '/api/docs/csi-snapshot-class-inventory', name: 'SnapClass', icon: '\u1F4F7' },
        { path: '/api/docs/mutating-webhook-catalog', name: 'Mut Webhook', icon: '\u1F50C' },
        { path: '/api/docs/validating-webhook-config-inventory', name: 'ValWH Config', icon: '\u2705' },
        { path: '/api/docs/ingress-class-inventory', name: 'Ing Class', icon: '\u1F6A7' },
        { path: '/api/docs/apiservice-registration-catalog', name: 'APISvc Reg', icon: '\u1F527' },
        { path: '/api/docs/storage-class-binding-mode', name: 'SC BindMode', icon: '\u1F4BE' },
        { path: '/api/docs/crd-version-catalog', name: 'CRD Ver', icon: '\u1F9E9' },
        ...
        { path: '/api/product/cm-key-exposure', name: 'CM Key Exposure', icon: '\u1F511' },
        { path: '/api/product/pvc-access-pattern', name: 'PVC Access', icon: '\u1F4BE' },
        { path: '/api/product/workload-insights', name: 'WL Insights', icon: '\u1F4CA' },
        { path: '/api/product/storage-summary', name: 'Storage Summary', icon: '\u1F4E6' },
        { path: '/api/product/network-topology-insights', name: 'Net Topology', icon: '\u1F310' },
        { path: '/api/product/pod-efficiency-score', name: 'Pod Efficiency', icon: '\u1F4CA' },
        { path: '/api/product/service-health-overview', name: 'Svc Health', icon: '\u2764' },
        { path: '/api/product/cluster-utilization-summary', name: 'Cluster Util', icon: '\u1F4CF' },
        { path: '/api/product/pod-uptime-tracker', name: 'Pod Uptime', icon: '\u23F1' },
        { path: '/api/product/namespace-cost-summary', name: 'NS Cost', icon: '\u1F4B0' },
        { path: '/api/product/replica-health-summary', name: 'Replica Health', icon: '\u2705' },
        { path: '/api/product/pod-density-score', name: 'Pod Density', icon: '\u1F4CF' },
        { path: '/api/product/image-cache-efficiency', name: 'Image Cache', icon: '\u1F4F7' },
        { path: '/api/product/node-bin-packing', name: 'Bin Packing', icon: '\u1F4E6' },
        { path: '/api/product/statefulset-health', name: 'STS Health', icon: '\u1F4E5' },
        { path: '/api/product/daemonset-coverage', name: 'DS Coverage', icon: '\u1F5C2' },
        { path: '/api/product/job-completion-rate', name: 'Job Rate', icon: '\u2705' },
        { path: '/api/product/cpu-throttle-est', name: 'CPU Throttle', icon: '\u23F1' },
        { path: '/api/product/image-layer-dedup', name: 'Img Dedup', icon: '\u1F4F7' },
        { path: '/api/product/pod-scheduling-latency', name: 'Sched Latency', icon: '\u23F3' },
        { path: '/api/product/vol-lifecycle-age', name: 'Vol Lifecycle', icon: '\u1F4BE' },
        { path: '/api/product/service-endpoint-health', name: 'Svc EP Health', icon: '\u1F310' },
        { path: '/api/product/image-tag-freshness', name: 'Img Tag Fresh', icon: '\u1F523' },
        { path: '/api/product/pod-restart-trend', name: 'Restart Trend', icon: '\u1F501' },
        { path: '/api/product/deployment-rollout-status', name: 'Rollout Status', icon: '\u1F504' },
        { path: '/api/product/pvc-binding-health', name: 'PVC Binding', icon: '\u1F4BE' },
        { path: '/api/product/hpa-target-utilization', name: 'HPA Target', icon: '\u1F4C8' },
        { path: '/api/product/replica-age-distribution', name: 'Replica Age', icon: '\u1F4C5' },
        { path: '/api/product/node-pod-affinity-score', name: 'Node Affinity', icon: '\u2696' },
        { path: '/api/product/pod-network-policy-match', name: 'Pod NetPol', icon: '\u1F6E1' },
        { path: '/api/product/deployment-maxunavailable', name: 'MaxUnavail', icon: '\u1F4C8' },
        { path: '/api/product/container-image-pull-policy', name: 'Pull Policy', icon: '\u2B07' },
        { path: '/api/product/pvc-resize-tracking', name: 'PVC Resize', icon: '\u1F4CF' },
        { path: '/api/product/service-type-distribution', name: 'Svc Type', icon: '\u1F310' },
        { path: '/api/product/pod-qos-distribution', name: 'QoS Dist', icon: '\u1F3AF' },
        ...
        { path: '/api/scalability/request-headroom', name: 'Request Headroom', icon: '\u1F4CF' },
        { path: '/api/scalability/failover-readiness', name: 'Failover Ready', icon: '\u1F6E1' },
        { path: '/api/scalability/api-object-count', name: 'Object Count', icon: '\u1F4CF' },
        { path: '/api/scalability/watch-cache-pressure', name: 'Watch Cache', icon: '\u1F441' },
        { path: '/api/scalability/scheduler-cache-health', name: 'Sched Cache', icon: '\u23F1' },
        { path: '/api/scalability/conntrack-capacity', name: 'Conntrack', icon: '\u1F517' },
        { path: '/api/scalability/ip-pool-health', name: 'IP Pool', icon: '\u1F310' },
        { path: '/api/scalability/resource-version-staleness', name: 'Res Version', icon: '\u1F501' },
        { path: '/api/scalability/node-allocatable-gap', name: 'Alloc Gap', icon: '\u1F4CF' },
        { path: '/api/scalability/pod-overhead-ratio', name: 'Pod Overhead', icon: '\u1F4CA' },
        { path: '/api/scalability/api-server-qps-est', name: 'API QPS Est', icon: '\u1F525' },
        { path: '/api/scalability/pod-topology-skew', name: 'Topo Skew', icon: '\u1F5FA' },
        { path: '/api/scalability/iptables-size', name: 'IPTables Size', icon: '\u2699' },
        { path: '/api/scalability/etcd-compaction', name: 'ETCD Compact', icon: '\u1F50C' },
        { path: '/api/scalability/kubelet-pod-limit', name: 'Pod Limit', icon: '\u1F4CF' },
        { path: '/api/scalability/dns-query-pressure', name: 'DNS Pressure', icon: '\u1F310' },
        { path: '/api/scalability/cni-ipam-capacity', name: 'CNI IPAM', icon: '\u1F517' },
        { path: '/api/scalability/control-plane-load', name: 'CP Load', icon: '\u1F680' },
        { path: '/api/scalability/volume-attach-density', name: 'Vol Attach', icon: '\u1F4BE' },
        { path: '/api/scalability/ns-quota-utilization', name: 'Quota Util', icon: '\u1F4CA' },
        { path: '/api/scalability/control-plane-ha', name: 'CP HA', icon: '\u1F6E1' },
        { path: '/api/scalability/anti-affinity-coverage', name: 'Anti-Affinity', icon: '\u1F5FA' },
        { path: '/api/scalability/request-headroom', name: 'Req Headroom', icon: '\u1F4CF' },
        { path: '/api/scalability/node-cordone-readiness', name: 'Cordon Ready', icon: '\u1F6DE' },
        { path: '/api/scalability/pv-reclaim-gap', name: 'PV Reclaim', icon: '\u1F9F9' },
        { path: '/api/scalability/cluster-object-budget', name: 'Obj Budget', icon: '\u1F4CA' },
        { path: '/api/scalability/etcd-db-size-estimator', name: 'ETCD Size', icon: '\u1F4BD' },
        { path: '/api/scalability/scheduler-cache-pressure', name: 'Sched Cache', icon: '\u1F9E0' },
        { path: '/api/scalability/apiserver-request-latency', name: 'API Latency', icon: '\u23F1' },
        { path: '/api/scalability/cluster-pod-density-trend', name: 'Pod Density', icon: '\u1F4CF' },
        { path: '/api/scalability/service-mesh-endpoint-budget', name: 'Mesh EP', icon: '\u1F310' },
        { path: '/api/scalability/node-allocatable-headroom', name: 'Alloc Head', icon: '\u1F4CA' },
        { path: '/api/scalability/cluster-label-cardinality', name: 'Label Card', icon: '\u1F3F7' },
        { path: '/api/scalability/configmap-size-budget', name: 'CM Size', icon: '\u1F4D0' },
        { path: '/api/scalability/epslice-address-budget', name: 'EPS Addr', icon: '\u1F310' },
        { path: '/api/deployment/sts-health', name: 'STS Health', icon: '\u1F4E6' },
        { path: '/api/deployment/image-pull-secret-gap', name: 'Pull Secret Gap', icon: '\u1F511' },
        { path: '/api/deployment/topology-distribution', name: 'Topology Dist', icon: '\u1F5FA' },
      ],
    },
  },
  'Deployment': {
    ...
    subcategories: {
      ...
      'Reproducibility & Compliance': [
        ...
        { path: '/api/deployment/annotation-compliance', name: 'Annot Compliance', icon: '\u1F4DD' },
        { path: '/api/deployment/multi-arch-audit', name: 'Multi-Arch', icon: '\u1F578' },
        { path: '/api/deployment/container-deps', name: 'Container Deps', icon: '\u1F9E9' },
        { path: '/api/deployment/helm-health', name: 'Helm Health', icon: '\u2693' },
        { path: '/api/deployment/antiaffinity-gap', name: 'Anti-Aff Gap', icon: '\u1F6E1' },
        { path: '/api/deployment/command-audit', name: 'Cmd Audit', icon: '\u1F4BB' },
        { path: '/api/deployment/annotation-signal', name: 'Annot Signal', icon: '\u1F4DD' },
        { path: '/api/deployment/dns-policy-audit', name: 'DNS Policy', icon: '\u1F310' },
        { path: '/api/deployment/pod-priority-preempt', name: 'Pod Priority', icon: '\u26A1' },
        { path: '/api/deployment/secret-env-ref', name: 'Secret Env Ref', icon: '\u1F511' },
        { path: '/api/deployment/resource-request-gap', name: 'Req Gap', icon: '\u2696' },
        { path: '/api/deployment/container-port-map', name: 'Port Map', icon: '\u1F50C' },
        { path: '/api/deployment/termination-message-audit', name: 'Term Msg', icon: '\u1F4DD' },
        { path: '/api/deployment/init-container-dep', name: 'Init Dep', icon: '\u1F9E9' },
        { path: '/api/deployment/strategy-compliance', name: 'Strategy', icon: '\u1F504' },
        { path: '/api/deployment/pull-secret-coverage', name: 'Pull Secret Cov', icon: '\u1F511' },
        { path: '/api/deployment/node-selector-audit', name: 'Node Selector', icon: '\u1F3AF' },
        { path: '/api/deployment/pod-os-selector', name: 'Pod OS', icon: '\u1F4BB' },
        { path: '/api/deployment/container-working-dir', name: 'Work Dir', icon: '\u1F4C2' },
        { path: '/api/deployment/container-stdin-tty', name: 'Stdin/TTY', icon: '\u2328' },
        { path: '/api/deployment/pod-dns-config', name: 'DNS Config', icon: '\u1F310' },
        { path: '/api/deployment/host-alias-audit', name: 'Host Alias', icon: '\u1F4CD' },
        { path: '/api/deployment/restart-policy-audit', name: 'Restart Pol', icon: '\u1F501' },
        { path: '/api/deployment/revision-history-audit', name: 'Rev History', icon: '\u1F4DC' },
        { path: '/api/deployment/container-env-health', name: 'Env Health', icon: '\u1F9EA' },
        { path: '/api/deployment/share-process-namespace', name: 'Share PID', icon: '\u1F517' },
        { path: '/api/deployment/pod-priority-audit', name: 'Pod Priority', icon: '\u26A1' },
        { path: '/api/deployment/container-subpath', name: 'SubPath', icon: '\u1F4C1' },
        { path: '/api/deployment/pod-ephemeral-storage', name: 'Eph Storage', icon: '\u1F4BE' },
        { path: '/api/deployment/deployment-condition-history', name: 'Cond History', icon: '\u1F4DC' },
        { path: '/api/deployment/container-resources-gap', name: 'Res Gap', icon: '\u2696' },
        { path: '/api/deployment/pod-sethostname-domain', name: 'Hostname', icon: '\u1F3E2' },
        { path: '/api/deployment/container-tc-egress-mark', name: 'TC Egress', icon: '\u1F6A7' },
        { path: '/api/deployment/pod-nodeselector-validation', name: 'NS Valid', icon: '\u2705' },
        { path: '/api/deployment/startup-probe-audit', name: 'Startup Probe', icon: '\u1F6A8' },
        { path: '/api/deployment/container-command-hash', name: 'Cmd Hash', icon: '\u1F9ED' },
        { path: '/api/deployment/deployment-strategy-type', name: 'Strategy Type', icon: '\u1F504' },
        { path: '/api/deployment/pod-toleration-scope', name: 'Tol Scope', icon: '\u1F6DE' },
        { path: '/api/deployment/container-port-hostport-map', name: 'HostPort Map', icon: '\u1F4CD' },
  ...
  'Documentation': {
    ...
    subcategories: {
      ...
      'Operations Docs': [
        ...
        { path: '/api/docs/policy-catalog', name: 'Policy Catalog', icon: '\u1F4DC' },
        { path: '/api/docs/service-dependency-graph', name: 'Dependency Graph', icon: '\u1F5FA' },
        { path: '/api/docs/performance-baseline', name: 'Perf Baseline', icon: '\u1F4CA' },
        { path: '/api/docs/naming-audit', name: 'Naming Audit', icon: '\u1F4DD' },
        { path: '/api/docs/env-var-catalog', name: 'Env Catalog', icon: '\u1F4F1' },
        { path: '/api/docs/annotation-inventory', name: 'Annot Inventory', icon: '\u1F3F7' },
      ],
    },
  },
};
