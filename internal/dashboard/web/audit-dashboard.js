  ...
  'Product': {
    ...
    subcategories: {
      ...
      'Network & Exposure': [
        ...
        { path: '/api/product/pod-anti-affinity-v2584', name: 'Pod AntiAffinity', icon: '\u{1F517}' },
        { path: '/api/product/env-var-count-v2584', name: 'EnvVar Count', icon: '\u{1F4CB}' },
        { path: '/api/product/lb-ingress-v2584', name: 'LB Ingress', icon: '\u{1F697}' },
        { path: '/api/deploy/rs-deletion-v2585', name: 'RS Deletion', icon: '\u{1F5D1}' },
        { path: '/api/deploy/sts-pvc-retention-v2585', name: 'STS PVC Retention', icon: '\u{1F4BF}' },
        { path: '/api/deploy/ds-template-gen-v2585', name: 'DS TemplateGen', icon: '\u{1F522}' },
        { path: '/api/ops/node-machine-id-v2586', name: 'Node MachineID', icon: '\u{1F4BB}' },
        { path: '/api/ops/pod-cidr-v2586', name: 'Node PodCIDR', icon: '\u{1F310}' },
        { path: '/api/ops/cpu-limit-detail-v2586', name: 'CPULimit Detail', icon: '\u26A1' },
        { path: '/api/security/supplemental-groups-v2587', name: 'SupplementalGroups', icon: '\u{1F465}' },
        { path: '/api/security/secret-type-label-v2587', name: 'Secret TypeLabel', icon: '\u{1F3F7}' },
        { path: '/api/security/rb-subject-api-group-v2587', name: 'RB SubjectAPIGroup', icon: '\u{1F4DD}' },
        { path: '/api/docs/node-boot-id-v2588', name: 'Node BootID', icon: '\u{1F4BB}' },
        { path: '/api/docs/tolerations-summary-v2588', name: 'Tolerations Summary', icon: '\u{1F6E1}' },
        { path: '/api/docs/ns-uid-vs-creation-v2588', name: 'NS UID vs Creation', icon: '\u{1F194}' },
        { path: '/api/scalability/top-ns-by-evt2-v2589', name: 'Top NS by Evt v2', icon: '\u{1F4C2}' },
        { path: '/api/scalability/node-cpu-alloc-summary-v2589', name: 'Node CPUAlloc Summary', icon: '\u26A1' },
        { path: '/api/scalability/cm-total-2589', name: 'CM Total', icon: '\u{1F4D1}' },
        { path: '/api/product/readiness-gates-v2590', name: 'ReadinessGates', icon: '\u2705' },
        { path: '/api/product/working-dir-v2590', name: 'WorkingDir', icon: '\u{1F4C1}' },
        { path: '/api/product/session-affinity-v2590', name: 'SessionAffinity', icon: '\u{1F517}' },
        { path: '/api/deploy/rs-label-count-v2591', name: 'RS LabelCount', icon: '\u{1F3F7}' },
        { path: '/api/deploy/sts-collision-detail-v2591', name: 'STS CollisionDetail', icon: '\u26A0' },
        { path: '/api/deploy/ds-node-selector-count-v2591', name: 'DS NodeSelector Count', icon: '\u{1F50D}' },
        { path: '/api/ops/runtime-dist-v2592', name: 'Runtime Dist', icon: '\u{1F4BB}' },
        { path: '/api/ops/node-selector-count-v2592', name: 'NodeSelector Count', icon: '\u{1F50D}' },
        { path: '/api/ops/image-latest-v2592', name: 'Image Latest', icon: '\u26A0' },
        { path: '/api/security/readonly-rootfs-v2593', name: 'ReadOnly RootFS', icon: '\u{1F6E1}' },
        { path: '/api/security/secret-owner-uid-v2593', name: 'Secret OwnerUID', icon: '\u{1F511}' },
        { path: '/api/security/rb-subject-name-v2593', name: 'RB SubjectName', icon: '\u{1F465}' },
        { path: '/api/docs/node-arch-stable-v2594', name: 'Node ArchStable', icon: '\u{1F4BB}' },
        { path: '/api/docs/pod-affinity-v2594', name: 'Pod Affinity', icon: '\u{1F517}' },
        { path: '/api/docs/ns-finalizer-detail-v2594', name: 'NS FinalizerDetail', icon: '\u{1F9F9}' },
        { path: '/api/scalability/top-ns-by-job2-v2595', name: 'Top NS by Job v2', icon: '\u{1F4CB}' },
        { path: '/api/scalability/node-mem-alloc-vs-lim-v2595', name: 'Node MemAlloc vs Lim', icon: '\u{1F4BE}' },
        { path: '/api/scalability/netpolicy-total2-v2595', name: 'NetPolicy Total v2', icon: '\u{1F6E1}' },
        { path: '/api/product/subdomain-v2596', name: 'Subdomain', icon: '\u{1F310}' },
        { path: '/api/product/resource-summary-detail-v2596', name: 'Resource Summary Detail', icon: '\u{1F4CA}' },
        { path: '/api/product/external-traffic-policy-v2596', name: 'ExternalTrafficPolicy', icon: '\u{1F697}' },
        { path: '/api/deploy/rs-owner-ref-count-v2597', name: 'RS OwnerRefCount', icon: '\u{1F517}' },
        { path: '/api/deploy/sts-min-ready-v2597', name: 'STS MinReady', icon: '\u23F1' },
        { path: '/api/deploy/ds-rolling-update-v2597', name: 'DS RollingUpdate', icon: '\u{1F504}' },
        { path: '/api/ops/nodeinfo-summary-v2598', name: 'NodeInfo Summary', icon: '\u{1F4BB}' },
        { path: '/api/ops/pod-vol-cm-v2598', name: 'Pod Vol CM', icon: '\u{1F4D1}' },
        { path: '/api/ops/cpu-req-detail-v2598', name: 'CPUReq Detail', icon: '\u26A1' },
        { path: '/api/security/host-ipc-detail-v2599', name: 'HostIPC Detail', icon: '\u26A0' },
        { path: '/api/security/secret-creation-dist-v2599', name: 'Secret CreationDist', icon: '\u{1F4C5}' },
        { path: '/api/security/cr-rule-api-group-v2599', name: 'CR RuleAPIGroup', icon: '\u{1F4DD}' },
        { path: '/api/docs/runtime-vs-kubelet-2600', name: 'Runtime vs Kubelet 2600', icon: '\u{1F4BB}' },
        { path: '/api/docs/pod-security-ctx-2600', name: 'Pod SecurityCtx 2600', icon: '\u{1F6E1}' },
        { path: '/api/docs/ns-phase-2600', name: 'NS Phase 2600', icon: '\u2705' },
        { path: '/api/scalability/top-ns-by-cron2-v2601', name: 'Top NS by Cron v2', icon: '\u{1F552}' },
        { path: '/api/scalability/node-stor-cap-vs-alloc-ratio-v2601', name: 'Node StorCap vs Alloc', icon: '\u{1F4BF}' },
        { path: '/api/scalability/hpa-min-replicas-v2601', name: 'HPA MinReplicas', icon: '\u26A1' },
        { path: '/api/product/pod-overhead-v2602', name: 'Pod Overhead', icon: '\u2696' },
        { path: '/api/product/cpu-limit-detail2-v2602', name: 'CPULimit Detail v2', icon: '\u26A1' },
        { path: '/api/product/svc-publish-not-ready-v2602', name: 'Svc PublishNotReady', icon: '\u{1F697}' },
        { path: '/api/deploy/rs-spec-vs-status-v2603', name: 'RS Spec vs Status', icon: '\u{1F4CF}' },
        { path: '/api/deploy/sts-strategy-detail-v2603', name: 'STS StrategyDetail', icon: '\u{1F504}' },
        { path: '/api/deploy/ds-min-ready-v2603', name: 'DS MinReady', icon: '\u23F1' },
        { path: '/api/ops/node-cpu-vs-mem-v2604', name: 'Node CPU vs Mem', icon: '\u26A1' },
        { path: '/api/ops/init-container-count-v2604', name: 'InitContainer Count', icon: '\u{1F4E6}' },
        { path: '/api/ops/stdin-once-v2604', name: 'StdinOnce', icon: '\u2328' },
        { path: '/api/security/seccomp-localhost-v2605', name: 'Seccomp Localhost', icon: '\u{1F6E1}' },
        { path: '/api/security/secret-string-data-v2605', name: 'Secret StringData', icon: '\u{1F511}' },
        { path: '/api/security/crb-roleref-kind-v2605', name: 'CRB RoleRefKind', icon: '\u{1F4DD}' },
        { path: '/api/docs/node-taints-summary-v2606', name: 'Node Taints Summary', icon: '\u26A0' },
        { path: '/api/docs/pod-nodename-v2606', name: 'Pod NodeName', icon: '\u{1F4CD}' },
        { path: '/api/docs/ns-phase-summary-v2606', name: 'NS Phase Summary', icon: '\u2705' },
        { path: '/api/scalability/top-ns-by-eps-v2607', name: 'Top NS by EPS', icon: '\u{1F4CD}' },
        { path: '/api/scalability/node-cpu-vs-mem-limit-v2607', name: 'Node CPU vs MemLimit', icon: '\u26A1' },
        { path: '/api/scalability/pv-total-by-phase2-v2607', name: 'PV Total by Phase v2', icon: '\u{1F4BF}' },
        { path: '/api/product/ephemeral-containers-v2608', name: 'EphemeralContainers', icon: '\u{1F4A5}' },
        { path: '/api/product/cpu-limit-summary-2608', name: 'CPULimit Summary 2608', icon: '\u26A1' },
        { path: '/api/product/svc-ip-family-v2608', name: 'Svc IPFamily', icon: '\u{1F310}' },
        { path: '/api/deploy/rs-finalizers-v2609', name: 'RS Finalizers', icon: '\u{1F9F9}' },
        { path: '/api/deploy/sts-vol-claim-v2609', name: 'STS VolClaim', icon: '\u{1F4BF}' },
        { path: '/api/deploy/ds-rev-history-v2609', name: 'DS RevHistory', icon: '\u{1F522}' },
        { path: '/api/ops/node-taint-effect-v2610', name: 'Node TaintEffect', icon: '\u26A0' },
        { path: '/api/ops/restart-policy-2610', name: 'RestartPolicy 2610', icon: '\u{1F501}' },
        { path: '/api/ops/lifecycle-hook-v2610', name: 'LifecycleHook', icon: '\u{1F534}' },
        { path: '/api/security/runas-non-root-v2611', name: 'RunAsNonRoot', icon: '\u{1F6E1}' },
        { path: '/api/security/secret-immutable-2611', name: 'Secret Immutable 2611', icon: '\u{1F512}' },
        { path: '/api/security/rb-roleref-apigroup-v2611', name: 'RB RoleRefAPIGroup', icon: '\u{1F4DD}' },
        { path: '/api/docs/node-taint-key-v2612', name: 'Node TaintKey', icon: '\u{1F511}' },
        { path: '/api/docs/pod-os-enabled-v2612', name: 'Pod OSEnabled', icon: '\u{1F4BB}' },
        { path: '/api/docs/ns-label-vs-spec-v2612', name: 'NS Label vs Spec', icon: '\u{1F3F7}' },
        { path: '/api/scalability/top-ns-by-pdb-v2613', name: 'Top NS by PDB', icon: '\u{1F6E1}' },
        { path: '/api/scalability/node-mem-req-vs-lim-v2613', name: 'Node MemReq vs Lim', icon: '\u{1F4CA}' },
        { path: '/api/scalability/epslice-port-v2613', name: 'EPSlice Port', icon: '\u{1F4F1}' },
        { path: '/api/product/pod-os-name-2614', name: 'Pod OSName 2614', icon: '\u{1F4BB}' },
        { path: '/api/product/resource-summary2-v2614', name: 'Resource Summary v2', icon: '\u{1F4CA}' },
        { path: '/api/product/svc-session-config-v2614', name: 'Svc SessionConfig', icon: '\u{1F517}' },
        { path: '/api/deploy/rs-conditions-count-v2615', name: 'RS ConditionsCount', icon: '\u{1F4CB}' },
        { path: '/api/deploy/sts-has-vct-v2615', name: 'STS HasVCT', icon: '\u{1F4BF}' },
        { path: '/api/deploy/ds-has-host-pid-v2615', name: 'DS HasHostPID', icon: '\u26A0' },
        { path: '/api/ops/node-provider-id-v2616', name: 'Node ProviderID', icon: '\u{1F4BB}' },
        { path: '/api/ops/pod-share-proc-ns-v2616', name: 'Pod ShareProcNS', icon: '\u{1F575}' },
        { path: '/api/ops/mem-limit-detail-v2616', name: 'MemLimit Detail', icon: '\u{1F4BE}' },
        { path: '/api/security/runas-group-v2617', name: 'RunAsGroup', icon: '\u{1F510}' },
        { path: '/api/security/secret-annot-key-v2617', name: 'Secret AnnotKey', icon: '\u{1F3F7}' },
        { path: '/api/security/cr-resource-name-v2617', name: 'CR ResourceName', icon: '\u{1F4DD}' },
        { path: '/api/docs/node-unschedulable-v2618', name: 'Node Unschedulable', icon: '\u26A0' },
        { path: '/api/docs/host-aliases-ip-v2618', name: 'HostAliases IP', icon: '\u{1F4CD}' },
        { path: '/api/docs/ns-creation-date-v2618', name: 'NS CreationDate', icon: '\u{1F4C5}' },
        { path: '/api/scalability/top-ns-by-secret3-v2619', name: 'Top NS by Secret v3', icon: '\u{1F511}' },
        { path: '/api/scalability/node-cpu-alloc-minmax-v2619', name: 'Node CPUAlloc MinMax', icon: '\u26A1' },
        { path: '/api/scalability/netpolicy-ingress-v2619', name: 'NetPolicy Ingress', icon: '\u{1F6E1}' },
        { path: '/api/product/preemption-policy-v2620', name: 'PreemptionPolicy', icon: '\u26A1' },
        { path: '/api/product/mem-req-detail-v2620', name: 'MemReq Detail', icon: '\u{1F4BE}' },
        { path: '/api/product/svc-alloc-lbnp-v2620', name: 'Svc AllocLBNP', icon: '\u{1F697}' },
        { path: '/api/deploy/rs-annot-detail-v2621', name: 'RS AnnotDetail', icon: '\u{1F3F7}' },
        { path: '/api/deploy/sts-avail-rep-v2621', name: 'STS AvailRep', icon: '\u2705' },
        { path: '/api/deploy/ds-num-unavail-v2621', name: 'DS NumUnavail', icon: '\u26A0' },
        { path: '/api/ops/node-kubelet-v2622', name: 'Node Kubelet 2622', icon: '\u{1F4BB}' },
        { path: '/api/ops/ctnr-vs-init-v2622', name: 'Ctnr vs Init', icon: '\u{1F4E6}' },
        { path: '/api/ops/ephemeral-limit-v2622', name: 'EphemeralLimit', icon: '\u{1F4BF}' },
        { path: '/api/security/cap-add-count-v2623', name: 'CapAdd Count', icon: '\u{1F6E1}' },
        { path: '/api/security/secret-owner-ref-count-v2623', name: 'Secret OwnerRefCount', icon: '\u{1F517}' },
        { path: '/api/security/cr-wildcard-verbs-v2623', name: 'CR WildcardVerbs', icon: '\u26A0' },
        { path: '/api/docs/node-sys-uuid-v2624', name: 'Node SysUUID', icon: '\u{1F194}' },
        { path: '/api/docs/pod-qos-class-v2624', name: 'Pod QOSClass', icon: '\u{1F3F7}' },
        { path: '/api/docs/ns-type-label-v2624', name: 'NS TypeLabel', icon: '\u{1F3F7}' },
        { path: '/api/scalability/top-ns-by-eps2-v2625', name: 'Top NS by EPS v2', icon: '\u{1F4CD}' },
        { path: '/api/scalability/node-cpu-req-total-v2625', name: 'Node CPUReq Total', icon: '\u26A1' },
        { path: '/api/scalability/hpa-max-replicas-v2625', name: 'HPA MaxReplicas', icon: '\u26A1' },
        { path: '/api/product/fqdn-v2626', name: 'SetHostnameFQDN', icon: '\u{1F310}' },
        { path: '/api/product/resource-summary3-v2626', name: 'Resource Summary v3', icon: '\u{1F4CA}' },
        { path: '/api/product/svc-internal-traffic-v2626', name: 'Svc InternalTraffic', icon: '\u{1F697}' },
        { path: '/api/deploy/rs-deletion-grace-v2627', name: 'RS DeletionGrace', icon: '\u23F1' },
        { path: '/api/deploy/sts-avail-detail-v2627', name: 'STS AvailDetail', icon: '\u2705' },
        { path: '/api/deploy/ds-desired-scheduled-v2627', name: 'DS DesiredScheduled', icon: '\u{1F4CF}' },
        { path: '/api/ops/node-kube-proxy-v2628', name: 'Node KubeProxy 2628', icon: '\u{1F4BB}' },
        { path: '/api/ops/pod-dns-search-v2628', name: 'Pod DNSSearch', icon: '\u{1F310}' },
        { path: '/api/ops/cpu-req-vs-lim-ratio-v2628', name: 'CPUReq vs Lim Ratio', icon: '\u26A1' },
        { path: '/api/security/seccomp-type-v2629', name: 'Seccomp Type', icon: '\u{1F6E1}' },
        { path: '/api/security/secret-data-size-v2629', name: 'Secret DataSize', icon: '\u{1F4BF}' },
        { path: '/api/security/cr-non-resource-urls-v2629', name: 'CR NonResourceURLs', icon: '\u{1F517}' },
        { path: '/api/docs/node-runtime-verbose-v2630', name: 'Node Runtime Verbose', icon: '\u{1F4BB}' },
        { path: '/api/docs/pod-host-network-v2630', name: 'Pod HostNetwork', icon: '\u{1F310}' },
        { path: '/api/docs/ns-annotated-count-v2630', name: 'NS AnnotatedCount', icon: '\u{1F3F7}' },
        { path: '/api/scalability/top-ns-by-netpolicy-v2631', name: 'Top NS by NetPolicy', icon: '\u{1F6E1}' },
        { path: '/api/scalability/node-mem-alloc-total-v2631', name: 'Node MemAlloc Total', icon: '\u{1F4BE}' },
        { path: '/api/scalability/pvc-bound-count-v2631', name: 'PVC BoundCount', icon: '\u{1F4BF}' },
        { path: '/api/product/pod-host-userspace-v2632', name: 'Pod HostUserspace', icon: '\u{1F4BB}' },
        { path: '/api/product/ephemeral-req-detail-v2632', name: 'EphemeralReq Detail', icon: '\u{1F4BF}' },
        { path: '/api/product/svc-traffic-dist-v2632', name: 'Svc TrafficDist', icon: '\u{1F697}' },
        { path: '/api/deploy/rs-spec-vs-status-v2633', name: 'RS Spec vs Status', icon: '\u{1F4CF}' },
        { path: '/api/deploy/sts-pvc-deleted-v2633', name: 'STS PVC Deleted', icon: '\u{1F5D1}' },
        { path: '/api/deploy/ds-schedule-daemon-v2633', name: 'DS ScheduleDaemon', icon: '\u{1F4CB}' },
        { path: '/api/ops/node-cond-true-v2634', name: 'Node CondTrue', icon: '\u2705' },
        { path: '/api/ops/topology-spread-v2634', name: 'Topology Spread', icon: '\u{1F310}' },
        { path: '/api/ops/env-from-cm-v2634', name: 'EnvFrom CM', icon: '\u{1F4D1}' },
        { path: '/api/security/fsgroup-change-v2635', name: 'FSGroupChange', icon: '\u{1F510}' },
        { path: '/api/security/secret-immutable2-v2635', name: 'Secret Immutable v2', icon: '\u{1F512}' },
        { path: '/api/security/rb-subject-apigroup-2635', name: 'RB SubjectAPIGroup 2635', icon: '\u{1F4DD}' },
        { path: '/api/docs/node-os-name-v2636', name: 'Node OSName 2636', icon: '\u{1F4BB}' },
        { path: '/api/docs/pod-os-enabled-2636', name: 'Pod OSEnabled 2636', icon: '\u{1F4BB}' },
        { path: '/api/docs/ns-label-key-count-v2636', name: 'NS LabelKeyCount', icon: '\u{1F3F7}' },
        { path: '/api/scalability/top-ns-by-hpa-v2637', name: 'Top NS by HPA', icon: '\u26A1' },
        { path: '/api/scalability/node-stor-alloc-vs-cap-v2637', name: 'Node StorAlloc vs Cap', icon: '\u{1F4BF}' },
        { path: '/api/scalability/pdb-min-available-v2637', name: 'PDB MinAvailable', icon: '\u{1F6E1}' },
        { path: '/api/product/priority-class-v2115', name: 'Priority Class', icon: '\u26A1' },
        { path: '/api/product/pod-restart-policy-v2638', name: 'Pod RestartPolicy', icon: '\u{1F504}' },
        { path: '/api/product/deploy-rev-hist-limit-v2638', name: 'Deploy RevHistLimit', icon: '\u{1F4DC}' },
        { path: '/api/product/svc-external-traffic-v2638', name: 'Svc ExternalTraffic', icon: '\u{1F697}' },
        { path: '/api/deploy/sts-update-strategy-v2639', name: 'STS UpdateStrategy', icon: '\u{1F504}' },
        { path: '/api/deploy/ds-update-strategy-v2639', name: 'DS UpdateStrategy', icon: '\u{1F504}' },
        { path: '/api/deploy/deploy-progress-deadline-v2639', name: 'Deploy ProgressDeadline', icon: '\u23F1' },
        { path: '/api/ops/pod-qos-class-v2640', name: 'Pod QOSClass', icon: '\u{1F4CA}' },
        { path: '/api/ops/node-kernel-version-v2640', name: 'Node KernelVersion', icon: '\u{1F527}' },
        { path: '/api/ops/ns-resource-quota-count-v2640', name: 'NS ResourceQuota', icon: '\u{1F4CB}' },
        { path: '/api/security/pod-priv-escalation-v2641', name: 'Pod PrivEscalation', icon: '\u{1F6E1}' },
        { path: '/api/security/sa-image-pull-secret-v2641', name: 'SA ImagePullSecret', icon: '\u{1F511}' },
        { path: '/api/security/pv-access-modes-v2641', name: 'PV AccessModes', icon: '\u{1F4BF}' },
        { path: '/api/docs/pod-tolerations-v2642', name: 'Pod Tolerations', icon: '\u{1F4DD}' },
        { path: '/api/docs/node-taints-count-v2642', name: 'Node TaintsCount', icon: '\u26A0' },
        { path: '/api/docs/crd-versions-v2642', name: 'CRD Versions', icon: '\u{1F4D6}' },
        { path: '/api/scalability/hpa-resource-type-v2643', name: 'HPA ResourceType', icon: '\u26A1' },
        { path: '/api/scalability/top-workloads-mem-v2643', name: 'Top Workloads Mem', icon: '\u{1F4BE}' },
        { path: '/api/scalability/ns-netpolicy-count-v2643', name: 'NS NetPolicy Count', icon: '\u{1F310}' },
        { path: '/api/product/pod-host-network-v2644', name: 'Pod HostNetwork', icon: '\u{1F310}' },
        { path: '/api/product/deploy-max-surge-v2644', name: 'Deploy MaxSurge', icon: '\u{1F4C8}' },
        { path: '/api/product/svc-session-affinity-v2644', name: 'Svc SessionAffinity', icon: '\u{1F517}' },
        { path: '/api/deploy/sts-pod-mgmt-policy-v2645', name: 'STS PodMgmtPolicy', icon: '\u{1F4CB}' },
        { path: '/api/deploy/ds-max-unavailable-v2645', name: 'DS MaxUnavailable', icon: '\u26A0' },
        { path: '/api/deploy/deploy-min-ready-v2645', name: 'Deploy MinReady', icon: '\u23F1' },
        { path: '/api/ops/pod-host-pid-v2646', name: 'Pod HostPID', icon: '\u{1F6E1}' },
        { path: '/api/ops/node-container-runtime-v2646', name: 'Node ContainerRuntime', icon: '\u{1F4E6}' },
        { path: '/api/ops/event-count-by-type-v2646', name: 'Event CountType', icon: '\u{1F4CB}' },
        { path: '/api/security/pod-run-as-non-root-v2647', name: 'Pod RunAsNonRoot', icon: '\u{1F6E1}' },
        { path: '/api/security/secret-type-dist-v2647', name: 'Secret TypeDist', icon: '\u{1F510}' },
        { path: '/api/security/node-ready-cond-v2647', name: 'Node ReadyCond', icon: '\u2705' },
        { path: '/api/docs/pod-image-count-v2648', name: 'Pod ImageCount', icon: '\u{1F4BD}' },
        { path: '/api/docs/node-pod-capacity-v2648', name: 'Node PodCapacity', icon: '\u{1F4AA}' },
        { path: '/api/docs/svc-port-count-v2648', name: 'Svc PortCount', icon: '\u{1F4F1}' },
        { path: '/api/scalability/hpa-target-util-v2649', name: 'HPA TargetUtil', icon: '\u{1F3AF}' },
        { path: '/api/scalability/top-ns-by-deploy-v2649', name: 'Top NS by Deploy', icon: '\u{1F4CA}' },
        { path: '/api/scalability/pvc-storage-class-v2649', name: 'PVC StorageClass', icon: '\u{1F4BF}' },
        { path: '/api/product/pod-dns-policy-v2650', name: 'Pod DNSPolicy', icon: '\u{1F310}' },
        { path: '/api/product/deploy-paused-v2650', name: 'Deploy Paused', icon: '\u23F8' },
        { path: '/api/product/svc-lb-class-v2650', name: 'Svc LBClass', icon: '\u{1F4A1}' },
        { path: '/api/deploy/sts-service-name-v2651', name: 'STS ServiceName', icon: '\u{1F517}' },
        { path: '/api/deploy/ds-template-hash-v2651', name: 'DS TemplateHash', icon: '\u{1F511}' },
        { path: '/api/deploy/deploy-strategy-type-v2651', name: 'Deploy StrategyType', icon: '\u{1F504}' },
        { path: '/api/ops/pod-readiness-gate-v2652', name: 'Pod ReadinessGate', icon: '\u2705' },
        { path: '/api/ops/node-allocatable-cpu-v2652', name: 'Node AllocCPU', icon: '\u{1F9BE}' },
        { path: '/api/ops/configmap-key-count-v2652', name: 'CM KeyCount', icon: '\u{1F4D1}' },
        { path: '/api/security/pod-readonly-rootfs-v2653', name: 'Pod ReadOnlyRootFS', icon: '\u{1F512}' },
        { path: '/api/security/pv-reclaim-policy-v2653', name: 'PV ReclaimPolicy', icon: '\u{1F5D1}' },
        { path: '/api/security/netpolicy-ingress-all-v2653', name: 'NetPol IngressAll', icon: '\u{1F6E1}' },
        { path: '/api/docs/pod-affinity-count-v2654', name: 'Pod AffinityCount', icon: '\u{1F517}' },
        { path: '/api/docs/node-arch-dist-v2654', name: 'Node ArchDist', icon: '\u{1F4BB}' },
        { path: '/api/docs/endpoint-slice-count-v2654', name: 'EndpointSlice Count', icon: '\u{1F4CD}' },
        { path: '/api/scalability/hpa-behavior-policy-v2655', name: 'HPA BehaviorPolicy', icon: '\u{1F9E0}' },
        { path: '/api/scalability/top-ns-by-sts-v2655', name: 'Top NS by STS', icon: '\u{1F4CA}' },
        { path: '/api/scalability/pv-phase-dist-v2655', name: 'PV PhaseDist', icon: '\u{1F4BF}' },
        { path: '/api/product/pod-term-grace-v2656', name: 'Pod TermGrace', icon: '\u23F1' },
        { path: '/api/product/deploy-conditions-v2656', name: 'Deploy Conditions', icon: '\u2705' },
        { path: '/api/product/svc-ip-family-v2656', name: 'Svc IPFamily', icon: '\u{1F310}' },
        { path: '/api/deploy/sts-partition-ord-v2657', name: 'STS PartitionOrd', icon: '\u{1F4CF}' },
        { path: '/api/deploy/ds-number-available-v2657', name: 'DS NumAvailable', icon: '\u{1F4CA}' },
        { path: '/api/deploy/deploy-replica-status-v2657', name: 'Deploy ReplicaStatus', icon: '\u{1F504}' },
        { path: '/api/ops/pod-phase-dist-v2658', name: 'Pod PhaseDist', icon: '\u{1F4CA}' },
        { path: '/api/ops/node-mem-pressure-v2658', name: 'Node MemPressure', icon: '\u{1F4BE}' },
        { path: '/api/ops/limit-range-audit-v2658', name: 'LimitRange Audit', icon: '\u{1F4CF}' },
        { path: '/api/security/pod-capabilities-v2659', name: 'Pod Capabilities', icon: '\u{1F6E1}' },
        { path: '/api/security/role-binding-kind-v2659', name: 'RoleBinding Kind', icon: '\u{1F4DD}' },
        { path: '/api/security/pdb-allowed-disrupt-v2659', name: 'PDB AllowedDisrupt', icon: '\u{1F6E1}' },
        { path: '/api/docs/pod-volume-count-v2660', name: 'Pod VolumeCount', icon: '\u{1F4BF}' },
        { path: '/api/docs/node-kubelet-version-v2660', name: 'Node KubeletVer', icon: '\u{1F527}' },
        { path: '/api/docs/ingress-tls-audit-v2660', name: 'Ingress TLSAudit', icon: '\u{1F512}' },
        { path: '/api/scalability/hpa-min-replicas-v2661', name: 'HPA MinReplicas', icon: '\u26A1' },
        { path: '/api/scalability/top-ns-by-pods-v2661', name: 'Top NS by Pods', icon: '\u{1F4CA}' },
        { path: '/api/scalability/storage-class-default-v2661', name: 'SC Default', icon: '\u{1F4BF}' },
        { path: '/api/product/pod-host-ipc-v2662', name: 'Pod HostIPC', icon: '\u{1F6E1}' },
        { path: '/api/product/deploy-available-v2662', name: 'Deploy Available', icon: '\u2705' },
        { path: '/api/product/svc-type-dist-v2662', name: 'Svc TypeDist', icon: '\u{1F681}' },
        { path: '/api/deploy/sts-observed-gen-v2663', name: 'STS ObservedGen', icon: '\u{1F504}' },
        { path: '/api/deploy/ds-current-num-v2663', name: 'DS CurrentNum', icon: '\u{1F4CA}' },
        { path: '/api/deploy/deploy-observed-gen-v2663', name: 'Deploy ObservedGen', icon: '\u{1F504}' },
        { path: '/api/ops/pod-container-count-v2664', name: 'Pod ContainerCount', icon: '\u{1F4E6}' },
        { path: '/api/ops/node-disk-pressure-v2664', name: 'Node DiskPressure', icon: '\u{1F4BF}' },
        { path: '/api/ops/ns-status-phase-v2664', name: 'NS StatusPhase', icon: '\u{1F4CB}' },
        { path: '/api/security/pod-seccomp-profile-v2665', name: 'Pod SeccompProfile', icon: '\u{1F6E1}' },
        { path: '/api/security/cluster-role-aggr-v2665', name: 'ClusterRole Aggr', icon: '\u{1F4DD}' },
        { path: '/api/security/sa-automount-token-v2665', name: 'SA AutoMountToken', icon: '\u{1F511}' },
        { path: '/api/docs/pod-priority-v2666', name: 'Pod Priority', icon: '\u26A1' },
        { path: '/api/docs/node-kube-proxy-ver-v2666', name: 'Node KubeProxyVer', icon: '\u{1F527}' },
        { path: '/api/docs/ingress-class-name-v2666', name: 'Ingress ClassName', icon: '\u{1F6A7}' },
        { path: '/api/scalability/hpa-scale-target-ref-v2667', name: 'HPA ScaleTargetRef', icon: '\u{1F3AF}' },
        { path: '/api/scalability/top-ns-by-cm-v2667', name: 'Top NS by CM', icon: '\u{1F4D1}' },
        { path: '/api/scalability/csi-worker-nodes-v2667', name: 'CSI WorkerNodes', icon: '\u{1F4A1}' },
