...
var auditRegistry = []auditEndpoint{
	...
	{"security:image-provenance", "/api/security/image-provenance-v2", "Container image provenance & registry trust auditor"},
	...
	{"security:image-provenance", "/api/security/image-provenance-v2", "Image supply chain provenance & registry trust"},
