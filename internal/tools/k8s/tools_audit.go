...
var auditRegistry = []auditEndpoint{
	...
	{"scalability:hpa-effectiveness", "/api/scalability/hpa-effectiveness", "HPA effectiveness & autoscaling posture analyzer"},
	{"scalability:scheduling-latency", "/api/scalability/scheduling-latency", "Pod scheduling latency & bottlenecks analyzer"},
	{"scalability:capacity-headroom", "/api/scalability/capacity-headroom", "Cluster capacity headroom & scaling calculator"},
