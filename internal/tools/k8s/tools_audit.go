...
var auditRegistry = []auditEndpoint{
	...
	{"security:dns-exfil-risk", "/api/security/dns-exfil-risk", "DNS exfiltration risk & egress policy auditor"},
	{"security:port-forward-audit", "/api/security/port-forward-audit", "Host port & NodePort exposure auditor"},
	{"security:image-provenance", "/api/security/image-provenance", "Image supply chain provenance & registry trust"},
